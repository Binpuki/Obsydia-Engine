...
class Packets
{
  ...
  public static var RECIEVE_CHAR_DATA(default, never) = new Packet([DataTypes.STRING]).id;
  public static var SEND_CHAR(default, never) = new Packet([DataTypes.FILE]).id;
  public static var RECIEVED_CHAR(default, never) = new Packet([DataTypes.UBYTE]).id;
