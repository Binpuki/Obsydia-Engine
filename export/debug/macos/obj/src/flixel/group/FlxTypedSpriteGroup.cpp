...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_212_draw,"flixel.group.FlxTypedSpriteGroup","draw",0x0c4e99b1,"flixel.group.FlxTypedSpriteGroup.draw","flixel/group/FlxSpriteGroup.hx",212,0xeb1fa7f3)
...
void FlxTypedSpriteGroup_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_212_draw)
HXLINE( 213)		this->group->draw();
HXLINE( 216)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 217)			this->drawDebug();
            		}
            	}
...
HXDLIN(1003)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
...
HXDLIN(1026)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
HXDLIN(1026)		return null();
            	}
...
HXDLIN(1038)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
HXDLIN(1038)		return null();
            	}
