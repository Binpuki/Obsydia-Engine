...
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_109_addMouse,"flixel.system.frontEnds.WatchFrontEnd","addMouse",0x3add9deb,"flixel.system.frontEnds.WatchFrontEnd.addMouse","flixel/system/frontEnds/WatchFrontEnd.hx",109,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_119_removeMouse,"flixel.system.frontEnds.WatchFrontEnd","removeMouse",0xc472d3fa,"flixel.system.frontEnds.WatchFrontEnd.removeMouse","flixel/system/frontEnds/WatchFrontEnd.hx",119,0xd7ade198)
namespace flixel{
...
HXLINE(  81)		 ::Dynamic parsedExpr = null();
...
void WatchFrontEnd_obj::addMouse(){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_109_addMouse)
HXDLIN( 109)		::flixel::FlxG_obj::game->debugger->watch->add(HX_("Mouse Position",44,8e,3a,9d),::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(( ( ::Dynamic)(::hx::ClassOf< ::flixel::FlxG >()) ),HX_("mouse",25,16,65,0c)));
            	}
...
void WatchFrontEnd_obj::removeMouse(){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_119_removeMouse)
HXDLIN( 119)		::flixel::FlxG_obj::game->debugger->watch->remove(null(),::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(( ( ::Dynamic)(::hx::ClassOf< ::flixel::FlxG >()) ),HX_("mouse",25,16,65,0c)));
            	}
