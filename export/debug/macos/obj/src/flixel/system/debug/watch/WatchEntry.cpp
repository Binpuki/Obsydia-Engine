...
HXDLIN(  60)				 ::Dynamic _g2 = _g->_hx_getObject(1);
...
HXDLIN(  92)			switch((int)(_g->_hx_getIndex())){
            				case (int)0: {
HXLINE(  94)					 ::Dynamic object = _g->_hx_getObject(0);
HXDLIN(  94)					::String field = _g->_hx_getString(1);
...
HXLINE(  98)					::String _g1 = _g->_hx_getString(0);
            				...
            				break;
            				case (int)2: {
HXLINE(  96)					 ::Dynamic _g1 = _g->_hx_getObject(1);
HXDLIN(  96)					{
...
HXDLIN( 111)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
HXLINE( 113)				 ::Dynamic object = _g->_hx_getObject(0);
HXDLIN( 113)				::String field = _g->_hx_getString(1);
...
HXDLIN( 115)				 ::Dynamic parsedExpr = _g->_hx_getObject(1);
...
HXLINE( 138)			 ::Dynamic object = _g->_hx_getObject(0);
HXDLIN( 138)			::String field = _g->_hx_getString(1);
