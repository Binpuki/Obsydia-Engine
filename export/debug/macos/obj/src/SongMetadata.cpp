...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_307_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",307,0x0d86f62d)
...
HXLINE( 311)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 310)		this->week = 0;
HXLINE( 309)		this->songName = HX_("",00,00,00,00);
HXLINE( 315)		this->songName = song;
HXLINE( 316)		this->week = week;
HXLINE( 317)		this->songCharacter = songCharacter;
            	}
