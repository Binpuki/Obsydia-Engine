...
bool PolymodAbstractScriptClass_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic PolymodAbstractScriptClass_Impl__obj::resolveField( ::polymod::hscript::PolymodScriptClass this1,::String name){
            	HX_GC_STACKFRAME(&_hx_pos_e5741ac3fc6c4841_8_resolveField)
...
HXLINE(  28)				switch((int)(nargs)){
            					case (int)0: {
            						HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0,::String,name1, ::Dynamic,_g) HXARGC(0)
            						 ::Dynamic _hx_run(){
            							HX_GC_STACKFRAME(&_hx_pos_e5741ac3fc6c4841_30_resolveField)
            					...
            					case (int)1: {
            						HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_1,::String,name1, ::Dynamic,_g) HXARGC(1)
            						 ::Dynamic _hx_run( ::Dynamic arg0){
            							HX_GC_STACKFRAME(&_hx_pos_e5741ac3fc6c4841_31_resolveField)
            					...
            					case (int)2: {
            						HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_2,::String,name1, ::Dynamic,_g) HXARGC(2)
            						 ::Dynamic _hx_run( ::Dynamic arg0, ::Dynamic arg1){
            							HX_GC_STACKFRAME(&_hx_pos_e5741ac3fc6c4841_32_resolveField)
            					...
            					case (int)3: {
            						HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_3,::String,name1, ::Dynamic,_g) HXARGC(3)
            						 ::Dynamic _hx_run( ::Dynamic arg0, ::Dynamic arg1, ::Dynamic arg2){
            							HX_GC_STACKFRAME(&_hx_pos_e5741ac3fc6c4841_33_resolveField)
            					...
            					case (int)4: {
            						HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_4,::String,name1, ::Dynamic,_g) HXARGC(4)
            						 ::Dynamic _hx_run( ::Dynamic arg0, ::Dynamic arg1, ::Dynamic arg2, ::Dynamic arg3){
            							HX_GC_STACKFRAME(&_hx_pos_e5741ac3fc6c4841_34_resolveField)
...
HXDLIN(  34)						return  ::Dynamic(new _hx_Closure_4(name1,_g));
            					...
            					break;
            					default:{
HXLINE(  35)						 ::polymod::hscript::PolymodInterpEx _this = this1->_interp;
HXDLIN(  35)						 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::ECustom(HX_("only 4 params allowed in script class functions (.bind limitation)",6b,b5,61,a2)),( (int)(_this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(_this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(_this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(_this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
