...
HXLINE(  89)		return this->super::fcall(o,f,args);
 ...
 ::Dynamic PolymodInterpEx_obj::assign( ::Dynamic e1, ::Dynamic e2){
            	HX_STACKFRAME(&_hx_pos_8f34cfa83fc6733e_113_assign)
HXLINE( 114)		 ::Dynamic v = this->expr(e2);
HXLINE( 115)		{
HXLINE( 115)			 ::hscript::ExprDef _g = e1->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 115)			if ((_g->_hx_getIndex() == 1)) {
HXLINE( 117)				::String id = _g->_hx_getString(0);
...
HXLINE( 172)					 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EUnknownVariable(f),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
...
HXLINE( 175)		return this->super::get(o,f);
 ...
 ::Dynamic PolymodInterpEx_obj::set( ::Dynamic o,::String f, ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_8f34cfa83fc6733e_179_set)
HXLINE( 180)		if (::hx::IsNull( o )) {
HXLINE( 181)			 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EInvalidAccess(f),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
...
HXLINE( 195)					 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EUnknownVariable(f),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
...
HXLINE( 199)		return this->super::set(o,f,v);
 ...
 ::Dynamic PolymodInterpEx_obj::resolve(::String id){
            	HX_GC_STACKFRAME(&_hx_pos_8f34cfa83fc6733e_205_resolve)
...
HXLINE( 278)					 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EUnknownVariable(id),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
HXDLIN( 278)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            				}
            				else {
HXLINE( 282)					 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EUnknownVariable(id),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
