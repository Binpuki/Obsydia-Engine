...
HXLINE( 243)				 ::polymod::hscript::PolymodInterpEx _this = this->_interp;
HXDLIN( 243)				 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::ECustom((HX_("could not resolve super class: ",59,6c,54,7d) + extendString)),( (int)(_this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(_this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(_this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(_this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
