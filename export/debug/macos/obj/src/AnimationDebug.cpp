...
HXLINE(  48)			{
HXLINE(  48)				 ::Character _this = this->dad;
...
HXLINE(  58)			{
HXLINE(  58)				 ::Boyfriend _this = this->bf;
...
HXLINE(  77)		{
HXLINE(  77)			 ::flixel::FlxObject _this1 = this->camFollow;
...
HXDLIN(  77)				_this1->set_x(((( (Float)(_hx_tmp) ) - _this1->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  77)				_this1->set_y(((( (Float)(_hx_tmp) ) - _this1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXDLIN( 121)			_hx_tmp2 = _this->keyManager->checkStatusUnsafe(74,_this->status);
            		}
            		else {
...
HXLINE( 121)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 121)			_hx_tmp1 = _this->keyManager->checkStatusUnsafe(75,_this->status);
            		}
            		else {
...
HXLINE( 121)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 121)			_hx_tmp = _this->keyManager->checkStatusUnsafe(76,_this->status);
            		}
            		else {
...
HXDLIN( 123)			if (_this->keyManager->checkStatusUnsafe(73,_this->status)) {
...
HXDLIN( 125)				if (_this->keyManager->checkStatusUnsafe(75,_this->status)) {
...
HXDLIN( 130)			if (_this1->keyManager->checkStatusUnsafe(74,_this1->status)) {
...
HXDLIN( 132)				if (_this->keyManager->checkStatusUnsafe(76,_this->status)) {
...
HXDLIN( 142)		if (_this3->keyManager->checkStatusUnsafe(87,_this3->status)) {
...
HXDLIN( 147)		if (_this4->keyManager->checkStatusUnsafe(83,_this4->status)) {
...
HXDLIN( 158)		 ::flixel::input::keyboard::FlxKeyList _this5 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 158)		if (!(_this5->keyManager->checkStatusUnsafe(83,_this5->status))) {
HXLINE( 158)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 158)			_hx_tmp4 = _this->keyManager->checkStatusUnsafe(87,_this->status);
            		}
            		else {
...
HXLINE( 158)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 158)			_hx_tmp3 = _this->keyManager->checkStatusUnsafe(32,_this->status);
            		}
            		else {
...
HXLINE( 171)		 ::flixel::input::keyboard::FlxKeyList _this6 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 171)		bool holdShift = _this6->keyManager->checkStatusUnsafe(16,_this6->status);
HXLINE( 172)		int multiplier = 1;
HXLINE( 173)		if (holdShift) {
HXLINE( 174)			multiplier = 10;
            		}
HXLINE( 176)		bool _hx_tmp5;
HXDLIN( 176)		bool _hx_tmp6;
HXDLIN( 176)		bool _hx_tmp7;
HXDLIN( 176)		if (!(upP)) {
HXLINE( 176)			_hx_tmp7 = rightP;
            		}
            		else {
HXLINE( 176)			_hx_tmp7 = true;
            		}
HXDLIN( 176)		if (!(_hx_tmp7)) {
HXLINE( 176)			_hx_tmp6 = downP;
            		}
            		else {
HXLINE( 176)			_hx_tmp6 = true;
            		}
HXDLIN( 176)		if (!(_hx_tmp6)) {
HXLINE( 176)			_hx_tmp5 = leftP;
            		}
            		else {
...
HXDLIN( 180)				int _hx_tmp = 1;
HXDLIN( 180)				base->set(_hx_tmp,(base->__get(_hx_tmp) + multiplier));
            			}
HXLINE( 181)			if (downP) {
HXLINE( 182)				::cpp::VirtualArray base = ( (::cpp::VirtualArray)(this->_hx_char->animOffsets->get(this->animList->__get(this->curAnim))) );
HXDLIN( 182)				int _hx_tmp = 1;
HXDLIN( 182)				base->set(_hx_tmp,(base->__get(_hx_tmp) - multiplier));
            			}
HXLINE( 183)			if (leftP) {
HXLINE( 184)				::cpp::VirtualArray base = ( (::cpp::VirtualArray)(this->_hx_char->animOffsets->get(this->animList->__get(this->curAnim))) );
HXDLIN( 184)				int _hx_tmp = 0;
HXDLIN( 184)				base->set(_hx_tmp,(base->__get(_hx_tmp) + multiplier));
            			}
HXLINE( 185)			if (rightP) {
HXLINE( 186)				::cpp::VirtualArray base = ( (::cpp::VirtualArray)(this->_hx_char->animOffsets->get(this->animList->__get(this->curAnim))) );
HXDLIN( 186)				int _hx_tmp = 0;
HXDLIN( 186)				base->set(_hx_tmp,(base->__get(_hx_tmp) - multiplier));
            			}
