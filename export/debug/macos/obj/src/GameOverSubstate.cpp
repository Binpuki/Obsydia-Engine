...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_90_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",90,0x01fbc1e7)
...
void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_90_beatHit)
HXLINE(  91)		this->super::beatHit();
HXLINE(  93)		::flixel::FlxG_obj::log->advanced(HX_("beat",76,e1,13,41),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
            	}
...
HXLINE( 110)					 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX )) ),false);
