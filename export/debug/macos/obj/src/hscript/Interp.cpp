...
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_82_posInfos,"hscript.Interp","posInfos",0x444859d0,"hscript.Interp.posInfos","hscript/Interp.hx",82,0xf078416e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_194_increment,"hscript.Interp","increment",0x1e81f590,"hscript.Interp.increment","hscript/Interp.hx",194,0xf078416e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_291_error,"hscript.Interp","error",0xe68736a9,"hscript.Interp.error","hscript/Interp.hx",291,0xf078416e)
...
HX_DEFINE_DYNAMIC_FUNC0(Interp_obj,resetVariables,(void))
 ...
 ::Dynamic Interp_obj::posInfos(){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_82_posInfos)
HXLINE(  84)		if (::hx::IsNotNull( this->curExpr )) {
...
HX_DEFINE_DYNAMIC_FUNC0(Interp_obj,initOps,(void))
 ...
 ::Dynamic Interp_obj::assign( ::Dynamic e1, ::Dynamic e2){
            	HX_GC_STACKFRAME(&_hx_pos_f37559d470356c9e_131_assign)
HXLINE( 132)		 ::Dynamic v = this->expr(e2);
HXLINE( 133)		{
HXLINE( 133)			 ::hscript::ExprDef _g = e1->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 133)			switch((int)(_g->_hx_getIndex())){
            				case (int)1: {
HXLINE( 134)					::String id = _g->_hx_getString(0);
HXDLIN( 134)					{
...
HXLINE( 139)							l->__SetField(HX_("r",72,00,00,00),v,::hx::paccDynamic);
            				...
            				break;
            				case (int)5: {
HXLINE( 140)					 ::Dynamic e = _g->_hx_getObject(0);
HXDLIN( 140)					::String f = _g->_hx_getString(1);
HXLINE( 141)					v = this->set(this->expr(e),f,v);
            				}
            				break;
            				case (int)16: {
HXLINE( 142)					 ::Dynamic e = _g->_hx_getObject(0);
HXDLIN( 142)					 ::Dynamic index = _g->_hx_getObject(1);
HXDLIN( 142)					{
...
HX_DEFINE_DYNAMIC_FUNC2(Interp_obj,assignOp,(void))
 ...
 ::Dynamic Interp_obj::evalAssignOp(::String op, ::Dynamic fop, ::Dynamic e1, ::Dynamic e2){
            	HX_GC_STACKFRAME(&_hx_pos_f37559d470356c9e_163_evalAssignOp)
HXLINE( 164)		 ::Dynamic v;
HXLINE( 165)		{
HXLINE( 165)			 ::hscript::ExprDef _g = e1->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 165)			switch((int)(_g->_hx_getIndex())){
            				case (int)1: {
HXLINE( 166)					::String id = _g->_hx_getString(0);
HXDLIN( 166)					{
...
HXLINE( 172)							l->__SetField(HX_("r",72,00,00,00),v,::hx::paccDynamic);
            				...
            				break;
            				case (int)5: {
HXLINE( 173)					 ::Dynamic e = _g->_hx_getObject(0);
HXDLIN( 173)					::String f = _g->_hx_getString(1);
HXDLIN( 173)					{
...
HXLINE( 176)						v = this->set(obj,f,v);
            				...
            				break;
            				case (int)16: {
HXLINE( 177)					 ::Dynamic e = _g->_hx_getObject(0);
HXDLIN( 177)					 ::Dynamic index = _g->_hx_getObject(1);
HXDLIN( 177)					{
...
HXLINE( 186)							arr->__SetItem(( (int)(index1) ),v);
            				...
            				break;
            				default:{
HXLINE( 189)					 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EInvalidOp(op),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
...
HX_DEFINE_DYNAMIC_FUNC4(Interp_obj,evalAssignOp,return )
 ...
 ::Dynamic Interp_obj::increment( ::Dynamic e,bool prefix,int delta){
            	HX_GC_STACKFRAME(&_hx_pos_f37559d470356c9e_194_increment)
HXLINE( 196)		this->curExpr = e;
HXLINE( 197)		 ::hscript::ExprDef e1 = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXLINE( 199)		switch((int)(e1->_hx_getIndex())){
            			case (int)1: {
HXLINE( 200)				::String id = e1->_hx_getString(0);
...
HXLINE( 208)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 209)				 ::Dynamic e = e1->_hx_getObject(0);
HXDLIN( 209)				::String f = e1->_hx_getString(1);
HXLINE( 210)				 ::Dynamic obj = this->expr(e);
...
HXLINE( 217)				return v;
            			...
            			break;
            			case (int)16: {
HXLINE( 218)				 ::Dynamic e = e1->_hx_getObject(0);
HXDLIN( 218)				 ::Dynamic index = e1->_hx_getObject(1);
HXLINE( 219)				 ::Dynamic arr = this->expr(e);
...
HXDLIN( 242)				 ::hscript::Error e1 =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EInvalidOp(e),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
...
HX_DEFINE_DYNAMIC_FUNC1(Interp_obj,restore,(void))
 ...
 ::Dynamic Interp_obj::error( ::hscript::ErrorDef e,::hx::Null< bool >  __o_rethrow){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_f37559d470356c9e_291_error)
HXLINE( 292)		 ::hscript::Error e1 =  ::hscript::Error_obj::__alloc( HX_CTX ,e,( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
HXLINE( 293)		if (rethrow) {
HXLINE( 293)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e1));
            		}
            		else {
HXLINE( 293)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e1));
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Interp_obj,rethrow,(void))
 ...
 ::Dynamic Interp_obj::resolve(::String id){
            	HX_GC_STACKFRAME(&_hx_pos_f37559d470356c9e_305_resolve)
...
HXLINE( 311)			 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EUnknownVariable(id),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
...
HXLINE( 317)		this->curExpr = e;
HXLINE( 318)		 ::hscript::ExprDef e1 = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXLINE( 320)		switch((int)(e1->_hx_getIndex())){
            			case (int)0: {
HXLINE( 321)				 ::hscript::Const c = e1->_hx_getObject(0).StaticCast<  ::hscript::Const >();
...
HXDLIN( 325)						return s;
            			...
            			break;
            			case (int)1: {
HXLINE( 330)				::String id = e1->_hx_getString(0);
HXLINE( 331)				return this->resolve(id);
            			}
            			break;
            			case (int)2: {
HXLINE( 332)				 ::hscript::CType _g = e1->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 332)				::String n = e1->_hx_getString(0);
HXDLIN( 332)				 ::Dynamic e = e1->_hx_getObject(2);
...
HXDLIN( 334)					if (::hx::IsNull( e )) {
HXLINE( 334)						value = null();
            					}
            					else {
HXLINE( 334)						value = this->expr(e);
            					}
...
HXLINE( 335)				return null();
            			...
            			break;
            			case (int)3: {
HXLINE( 336)				 ::Dynamic e = e1->_hx_getObject(0);
HXLINE( 337)				return this->expr(e);
            			}
            			break;
            			case (int)4: {
HXLINE( 338)				::Array< ::Dynamic> exprs = e1->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 339)				int old = this->declared->length;
HXLINE( 340)				 ::Dynamic v = null();
HXLINE( 341)				{
HXLINE( 341)					int _g = 0;
HXDLIN( 341)					while((_g < exprs->length)){
HXLINE( 341)						 ::Dynamic e = exprs->__get(_g);
HXDLIN( 341)						_g = (_g + 1);
...
HXLINE( 344)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 345)				 ::Dynamic e = e1->_hx_getObject(0);
HXDLIN( 345)				::String f = e1->_hx_getString(1);
HXLINE( 346)				return this->get(this->expr(e),f);
            			}
            			break;
            			case (int)6: {
HXLINE( 347)				::String op = e1->_hx_getString(0);
HXDLIN( 347)				 ::Dynamic e11 = e1->_hx_getObject(1);
HXDLIN( 347)				 ::Dynamic e2 = e1->_hx_getObject(2);
HXLINE( 348)				 ::Dynamic fop = this->binops->get(op);
HXLINE( 349)				if (::hx::IsNull( fop )) {
HXLINE( 349)					 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EInvalidOp(op),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
HXDLIN( 349)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            				}
HXLINE( 350)				return fop(e11,e2);
            			}
            			break;
            			case (int)7: {
HXLINE( 351)				::String op = e1->_hx_getString(0);
HXDLIN( 351)				bool prefix = e1->_hx_getBool(1);
HXDLIN( 351)				 ::Dynamic e = e1->_hx_getObject(2);
HXLINE( 352)				::String _hx_switch_0 = op;
            				if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 354)					return ::hx::IsNotEq( this->expr(e),true );
HXDLIN( 354)					goto _hx_goto_51;
            				}
            				if (  (_hx_switch_0==HX_("++",a0,25,00,00)) ){
HXLINE( 358)					return this->increment(e,prefix,1);
HXDLIN( 358)					goto _hx_goto_51;
            				}
            				if (  (_hx_switch_0==HX_("-",2d,00,00,00)) ){
HXLINE( 356)					return -(this->expr(e));
HXDLIN( 356)					goto _hx_goto_51;
            				}
            				if (  (_hx_switch_0==HX_("--",60,27,00,00)) ){
HXLINE( 360)					return this->increment(e,prefix,-1);
HXDLIN( 360)					goto _hx_goto_51;
            				}
            				if (  (_hx_switch_0==HX_("~",7e,00,00,00)) ){
HXLINE( 365)					return ~(( (int)(this->expr(e)) ));
HXDLIN( 365)					goto _hx_goto_51;
            				}
            				/* default */{
HXLINE( 368)					 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EInvalidOp(op),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
HXDLIN( 368)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            			...
            			break;
            			case (int)8: {
HXLINE( 370)				 ::Dynamic e = e1->_hx_getObject(0);
HXDLIN( 370)				::Array< ::Dynamic> params = e1->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 371)				::cpp::VirtualArray args = ::cpp::VirtualArray_obj::__new();
HXLINE( 372)				{
HXLINE( 372)					int _g = 0;
HXDLIN( 372)					while((_g < params->length)){
HXLINE( 372)						 ::Dynamic p = params->__get(_g);
HXDLIN( 372)						_g = (_g + 1);
HXLINE( 373)						args->push(this->expr(p));
            					}
            				}
HXLINE( 375)				 ::hscript::ExprDef _g1 = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 375)				if ((_g1->_hx_getIndex() == 5)) {
HXLINE( 376)					 ::Dynamic e = _g1->_hx_getObject(0);
HXDLIN( 376)					::String f = _g1->_hx_getString(1);
HXLINE( 377)					 ::Dynamic obj = this->expr(e);
HXLINE( 378)					if (::hx::IsNull( obj )) {
HXLINE( 378)						 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EInvalidAccess(f),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
HXDLIN( 378)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            					}
HXLINE( 379)					return this->fcall(obj,f,args);
            				}
            				else {
HXLINE( 381)					return this->call(null(),this->expr(e),args);
            				}
            			}
            			break;
            			case (int)9: {
HXLINE( 383)				 ::Dynamic econd = e1->_hx_getObject(0);
HXDLIN( 383)				 ::Dynamic e11 = e1->_hx_getObject(1);
HXDLIN( 383)				 ::Dynamic e2 = e1->_hx_getObject(2);
HXLINE( 384)				if (::hx::IsEq( this->expr(econd),true )) {
HXLINE( 384)					return this->expr(e11);
            				}
            				else {
...
HXLINE( 384)						return this->expr(e2);
            			...
            			break;
            			case (int)10: {
HXLINE( 385)				 ::Dynamic econd = e1->_hx_getObject(0);
HXDLIN( 385)				 ::Dynamic e = e1->_hx_getObject(1);
HXLINE( 386)				this->whileLoop(econd,e);
HXLINE( 387)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 391)				::String v = e1->_hx_getString(0);
HXDLIN( 391)				 ::Dynamic it = e1->_hx_getObject(1);
HXDLIN( 391)				 ::Dynamic e = e1->_hx_getObject(2);
HXLINE( 392)				this->forLoop(v,it,e);
...
HXLINE( 401)				 ::hscript::CType _g = e1->_hx_getObject(3).StaticCast<  ::hscript::CType >();
HXDLIN( 401)				::Array< ::Dynamic> params = e1->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 401)				 ::Dynamic fexpr = e1->_hx_getObject(1);
HXDLIN( 401)				::String name = e1->_hx_getString(2);
...
HXLINE( 469)				return f1;
            			...
            			break;
            			case (int)15: {
HXLINE( 398)				 ::Dynamic e = e1->_hx_getObject(0);
HXLINE( 399)				 ::Dynamic _hx_tmp;
HXDLIN( 399)				if (::hx::IsNull( e )) {
HXLINE( 399)					_hx_tmp = null();
            				}
            				else {
HXLINE( 399)					_hx_tmp = this->expr(e);
            				}
...
HXLINE( 400)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SReturn_dyn()));
            			...
            			break;
            			case (int)16: {
HXLINE( 512)				 ::Dynamic e = e1->_hx_getObject(0);
HXDLIN( 512)				 ::Dynamic index = e1->_hx_getObject(1);
HXLINE( 513)				 ::Dynamic arr = this->expr(e);
...
HXLINE( 519)					return arr->__GetItem(( (int)(index1) ));
            			...
            			break;
            			case (int)17: {
HXLINE( 470)				::Array< ::Dynamic> arr = e1->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 471)				bool _hx_tmp;
HXDLIN( 471)				if ((arr->length > 0)) {
HXLINE( 471)					 ::hscript::ExprDef _g = arr->__get(0)->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 471)					if ((_g->_hx_getIndex() == 6)) {
HXLINE( 471)						 ::Dynamic _g1 = _g->_hx_getObject(1);
HXDLIN( 471)						 ::Dynamic _g2 = _g->_hx_getObject(2);
...
HXLINE( 478)							 ::Dynamic e = arr->__get(_g);
HXDLIN( 478)							_g = (_g + 1);
HXLINE( 479)							{
HXLINE( 479)								 ::hscript::ExprDef _g1 = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 479)								if ((_g1->_hx_getIndex() == 6)) {
HXLINE( 480)									if ((_g1->_hx_getString(0) == HX_("=>",61,35,00,00))) {
HXLINE( 480)										 ::Dynamic eKey = _g1->_hx_getObject(1);
HXDLIN( 480)										 ::Dynamic eValue = _g1->_hx_getObject(2);
HXDLIN( 480)										{
...
HXLINE( 507)							 ::Dynamic e = arr->__get(_g);
HXDLIN( 507)							_g = (_g + 1);
...
HXLINE( 510)					return a;
            			...
            			break;
            			case (int)18: {
HXLINE( 521)				::String cl = e1->_hx_getString(0);
HXDLIN( 521)				::Array< ::Dynamic> params = e1->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 522)				::cpp::VirtualArray a = ::cpp::VirtualArray_obj::__new();
HXLINE( 523)				{
HXLINE( 523)					int _g = 0;
HXDLIN( 523)					while((_g < params->length)){
HXLINE( 523)						 ::Dynamic e = params->__get(_g);
HXDLIN( 523)						_g = (_g + 1);
...
HXLINE( 525)				return this->cnew(cl,a);
            			...
            			break;
            			case (int)19: {
HXLINE( 526)				 ::Dynamic e = e1->_hx_getObject(0);
HXLINE( 527)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(this->expr(e)));
            			}
            			break;
            			case (int)20: {
HXLINE( 528)				 ::hscript::CType _g = e1->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 528)				 ::Dynamic e = e1->_hx_getObject(0);
HXDLIN( 528)				::String n = e1->_hx_getString(1);
HXDLIN( 528)				 ::Dynamic ecatch = e1->_hx_getObject(3);
HXLINE( 529)				int old = this->declared->length;
HXLINE( 530)				bool oldTry = this->inTry;
HXLINE( 531)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 532)					this->inTry = true;
HXLINE( 533)					 ::Dynamic v = this->expr(e);
...
HXLINE( 549)							return v;
            			...
            			break;
            			case (int)21: {
HXLINE( 551)				::Array< ::Dynamic> fl = e1->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 555)				return o;
            			...
            			break;
            			case (int)22: {
HXLINE( 556)				 ::Dynamic econd = e1->_hx_getObject(0);
HXDLIN( 556)				 ::Dynamic e11 = e1->_hx_getObject(1);
HXDLIN( 556)				 ::Dynamic e2 = e1->_hx_getObject(2);
HXLINE( 557)				if (::hx::IsEq( this->expr(econd),true )) {
HXLINE( 557)					return this->expr(e11);
            				}
            				else {
HXLINE( 557)					return this->expr(e2);
            			...
            			break;
            			case (int)23: {
HXLINE( 558)				 ::Dynamic e = e1->_hx_getObject(0);
HXDLIN( 558)				::Array< ::Dynamic> cases = e1->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 558)				 ::Dynamic def = e1->_hx_getObject(2);
HXLINE( 559)				 ::Dynamic val = this->expr(e);
...
HXLINE( 562)								 ::Dynamic v = _g2->__get(_g1);
...
HXDLIN( 388)				 ::Dynamic e = e1->_hx_getObject(1);
HXLINE( 389)				this->doWhileLoop(econd,e);
HXLINE( 390)				return null();
            			}
            			break;
            			case (int)25: {
HXLINE( 575)				::String _g = e1->_hx_getString(0);
HXDLIN( 575)				::Array< ::Dynamic> _g1 = e1->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 575)				 ::Dynamic e = e1->_hx_getObject(2);
HXLINE( 576)				return this->expr(e);
            			}
            			break;
            			case (int)26: {
HXLINE( 577)				 ::hscript::CType _g = e1->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 577)				 ::Dynamic e = e1->_hx_getObject(0);
HXLINE( 578)				return this->expr(e);
            			}
            			break;
            		}
...
HX_DEFINE_DYNAMIC_FUNC2(Interp_obj,whileLoop,(void))
 ...
 ::Dynamic Interp_obj::makeIterator( ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_f37559d470356c9e_616_makeIterator)
HXLINE( 620)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 622)			 ::hscript::Error e =  ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EInvalidIterator(v),( (int)(this->curExpr->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),( (::String)(this->curExpr->__Field(HX_("origin",e6,19,01,4b),::hx::paccDynamic)) ),( (int)(this->curExpr->__Field(HX_("line",f4,17,b3,47),::hx::paccDynamic)) ));
...
HX_DEFINE_DYNAMIC_FUNC3(Interp_obj,setMapValue,(void))
 ...
 ::Dynamic Interp_obj::get( ::Dynamic o,::String f){
            	HX_GC_STACKFRAME(&_hx_pos_f37559d470356c9e_657_get)
...
HX_DEFINE_DYNAMIC_FUNC2(Interp_obj,get,return )
 ...
 ::Dynamic Interp_obj::set( ::Dynamic o,::String f, ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_f37559d470356c9e_673_set)
