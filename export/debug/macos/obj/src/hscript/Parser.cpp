...
HX_LOCAL_STACK_FRAME(_hx_pos_2fd3d36595bebf3d_205_push,"hscript.Parser","push",0xe0f2532e,"hscript.Parser.push","hscript/Parser.hx",205,0x98735743)
...
HX_LOCAL_STACK_FRAME(_hx_pos_2fd3d36595bebf3d_245_expr,"hscript.Parser","expr",0xd9af3e89,"hscript.Parser.expr","hscript/Parser.hx",245,0x98735743)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd3d36595bebf3d_253_pmin,"hscript.Parser","pmin",0xe0ec3876,"hscript.Parser.pmin","hscript/Parser.hx",253,0x98735743)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd3d36595bebf3d_261_pmax,"hscript.Parser","pmax",0xe0ec3188,"hscript.Parser.pmax","hscript/Parser.hx",261,0x98735743)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd3d36595bebf3d_267_mk,"hscript.Parser","mk",0xd828e3b2,"hscript.Parser.mk","hscript/Parser.hx",267,0x98735743)
...
HX_LOCAL_STACK_FRAME(_hx_pos_2fd3d36595bebf3d_1333__token,"hscript.Parser","_token",0x5e76088e,"hscript.Parser._token","hscript/Parser.hx",1333,0x98735743)
...
void Parser_obj::error( ::hscript::ErrorDef err,int pmin,int pmax){
            	HX_GC_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_150_error)
HXDLIN( 150)		if (!(this->resumeErrors)) {
HXLINE( 152)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,err,pmin,pmax,this->origin,this->line)));
            		}
            	}
...
void Parser_obj::invalidChar(int c){
            	HX_GC_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_159_invalidChar)
HXDLIN( 159)		if (!(this->resumeErrors)) {
HXDLIN( 159)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EInvalidChar(c),(this->readPos - 1),(this->readPos - 1),this->origin,this->line)));
            		}
            	}
...
HXLINE( 166)		this->origin = origin;
HXLINE( 167)		this->readPos = 0;
HXLINE( 168)		this->tokenMin = (this->oldTokenMin = 0);
HXLINE( 169)		this->tokenMax = (this->oldTokenMax = 0);
HXLINE( 170)		this->tokens =  ::haxe::ds::List_obj::__alloc( HX_CTX );
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,initParser,(void))
 ...
 ::Dynamic Parser_obj::parseString(::String s,::String __o_origin){
            	...
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_186_parseString)
...
HXDLIN( 194)				this->tokenMin = this->oldTokenMin;
HXDLIN( 194)				this->tokenMax = this->oldTokenMax;
            			}
HXLINE( 195)			this->parseFullExpr(a);
            		}
            		_hx_goto_18:;
HXLINE( 197)		if ((a->length == 1)) {
HXLINE( 197)			return a->__get(0);
            		}
            		else {
HXLINE( 197)			 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EBlock(a);
HXDLIN( 197)			 ::Dynamic pmin = 0;
HXDLIN( 197)			 ::Dynamic pmax = null();
HXDLIN( 197)			if (::hx::IsNull( e )) {
HXLINE( 197)				return null();
            			}
            			else {
HXLINE( 197)				if (::hx::IsNull( pmin )) {
HXLINE( 197)					pmin = this->tokenMin;
            				}
HXDLIN( 197)				if (::hx::IsNull( pmax )) {
HXLINE( 197)					pmax = this->tokenMax;
            				}
HXDLIN( 197)				return  ::Dynamic(::hx::Anon_obj::Create(5)
...
HX_DEFINE_DYNAMIC_FUNC2(Parser_obj,parseString,return )
 ...
 ::Dynamic Parser_obj::unexpected( ::hscript::Token tk){
            	HX_GC_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_200_unexpected)
HXLINE( 201)		{
HXLINE( 201)			 ::hscript::ErrorDef err = ::hscript::ErrorDef_obj::EUnexpected(this->tokenString(tk));
HXDLIN( 201)			if (!(this->resumeErrors)) {
HXLINE( 201)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,err,this->tokenMin,this->tokenMax,this->origin,this->line)));
            			}
            		}
...
void Parser_obj::push( ::hscript::Token tk){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_205_push)
HXLINE( 207)		this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            			->setFixed(0,HX_("t",74,00,00,00),tk)
            			->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            			->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXLINE( 208)		this->tokenMin = this->oldTokenMin;
HXLINE( 209)		this->tokenMax = this->oldTokenMax;
            	}
...
bool Parser_obj::maybe( ::hscript::Token tk){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_225_maybe)
HXLINE( 226)		 ::hscript::Token t = this->token();
HXLINE( 227)		if (__hxcpp_enum_eq(t,tk)) {
HXLINE( 228)			return true;
            		}
HXLINE( 229)		{
HXLINE( 229)			this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            				->setFixed(0,HX_("t",74,00,00,00),t)
            				->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            				->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 229)			this->tokenMin = this->oldTokenMin;
HXDLIN( 229)			this->tokenMax = this->oldTokenMax;
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,getIdent,return )
 ...
 ::hscript::ExprDef Parser_obj::expr( ::Dynamic e){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_245_expr)
HXDLIN( 245)		return e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
            	}
...
int Parser_obj::pmin( ::Dynamic e){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_253_pmin)
HXDLIN( 253)		if (::hx::IsNull( e )) {
HXDLIN( 253)			return 0;
            		}
            		else {
HXDLIN( 253)			return ( (int)(e->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) );
            		}
HXDLIN( 253)		return 0;
            	}
...
int Parser_obj::pmax( ::Dynamic e){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_261_pmax)
HXDLIN( 261)		if (::hx::IsNull( e )) {
HXDLIN( 261)			return 0;
            		}
            		else {
HXDLIN( 261)			return ( (int)(e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) );
            		}
HXDLIN( 261)		return 0;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,pmax,return )
 ...
 ::Dynamic Parser_obj::mk( ::hscript::ExprDef e, ::Dynamic pmin, ::Dynamic pmax){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_267_mk)
HXLINE( 269)		if (::hx::IsNull( e )) {
HXLINE( 269)			return null();
            		}
HXLINE( 270)		if (::hx::IsNull( pmin )) {
HXLINE( 270)			pmin = this->tokenMin;
            		}
HXLINE( 271)		if (::hx::IsNull( pmax )) {
HXLINE( 271)			pmax = this->tokenMax;
            		}
HXLINE( 272)		return  ::Dynamic(::hx::Anon_obj::Create(5)
            			->setFixed(0,HX_("e",65,00,00,00),e)
            			->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            			->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            			->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 280)		 ::hscript::ExprDef _g = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 280)		switch((int)(_g->_hx_getIndex())){
            			case (int)2: {
HXLINE( 283)				::String _g1 = _g->_hx_getString(0);
HXDLIN( 283)				 ::hscript::CType t = _g->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 283)				 ::Dynamic e = _g->_hx_getObject(2);
HXDLIN( 283)				if (::hx::IsNotNull( e )) {
...
HXLINE( 283)						return false;
            			...
            			break;
            			case (int)4: {
HXLINE( 281)				::Array< ::Dynamic> _g1 = _g->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 281)				return true;
            			}
            			break;
            			case (int)6: {
HXLINE( 285)				::String _g1 = _g->_hx_getString(0);
HXDLIN( 285)				 ::Dynamic _g2 = _g->_hx_getObject(1);
HXDLIN( 285)				 ::Dynamic e = _g->_hx_getObject(2);
HXDLIN( 285)				return this->isBlock(e);
            			}
            			break;
            			case (int)7: {
HXLINE( 286)				::String _g1 = _g->_hx_getString(0);
HXDLIN( 286)				bool prefix = _g->_hx_getBool(1);
HXDLIN( 286)				 ::Dynamic e = _g->_hx_getObject(2);
HXDLIN( 286)				if (!(prefix)) {
HXLINE( 286)					return this->isBlock(e);
            				}
            				else {
...
HXDLIN( 284)				 ::Dynamic e1 = _g->_hx_getObject(1);
HXDLIN( 284)				 ::Dynamic e2 = _g->_hx_getObject(2);
...
HXLINE( 284)					return this->isBlock(e1);
            			...
            			break;
            			case (int)10: {
HXLINE( 287)				 ::Dynamic _g1 = _g->_hx_getObject(0);
HXDLIN( 287)				 ::Dynamic e = _g->_hx_getObject(1);
HXDLIN( 287)				return this->isBlock(e);
            			}
            			break;
            			case (int)11: {
HXLINE( 289)				::String _g1 = _g->_hx_getString(0);
HXDLIN( 289)				 ::Dynamic _g2 = _g->_hx_getObject(1);
HXDLIN( 289)				 ::Dynamic e = _g->_hx_getObject(2);
HXDLIN( 289)				return this->isBlock(e);
            			}
            			break;
            			case (int)14: {
HXLINE( 282)				::Array< ::Dynamic> _g1 = _g->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 282)				::String _g2 = _g->_hx_getString(2);
HXDLIN( 282)				 ::hscript::CType _g3 = _g->_hx_getObject(3).StaticCast<  ::hscript::CType >();
HXDLIN( 282)				 ::Dynamic e = _g->_hx_getObject(1);
HXDLIN( 282)				return this->isBlock(e);
            			}
            			break;
            			case (int)15: {
HXLINE( 290)				 ::Dynamic e = _g->_hx_getObject(0);
HXDLIN( 290)				if (::hx::IsNotNull( e )) {
HXLINE( 290)					return this->isBlock(e);
            				}
            				else {
HXLINE( 290)					return false;
            			...
            			break;
            			case (int)20: {
HXLINE( 291)				 ::Dynamic _g1 = _g->_hx_getObject(0);
HXDLIN( 291)				::String _g2 = _g->_hx_getString(1);
HXDLIN( 291)				 ::hscript::CType _g3 = _g->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 291)				 ::Dynamic e = _g->_hx_getObject(3);
HXDLIN( 291)				return this->isBlock(e);
            			}
            			break;
            			case (int)21: {
HXLINE( 281)				::Array< ::Dynamic> _g1 = _g->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXDLIN( 281)				::Array< ::Dynamic> _g2 = _g->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 281)				 ::Dynamic _g3 = _g->_hx_getObject(2);
HXDLIN( 281)				return true;
            			}
            			break;
            			case (int)24: {
HXLINE( 288)				 ::Dynamic _g1 = _g->_hx_getObject(0);
HXDLIN( 288)				 ::Dynamic e = _g->_hx_getObject(1);
HXDLIN( 288)				return this->isBlock(e);
            			}
            			break;
            			case (int)25: {
HXLINE( 292)				::String _g1 = _g->_hx_getString(0);
HXDLIN( 292)				::Array< ::Dynamic> _g2 = _g->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 292)				 ::Dynamic e = _g->_hx_getObject(2);
HXDLIN( 292)				return this->isBlock(e);
            			}
            			break;
            			default:{
...
void Parser_obj::parseFullExpr(::Array< ::Dynamic> exprs){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_297_parseFullExpr)
HXLINE( 298)		 ::Dynamic e = this->parseExpr();
...
HXLINE( 303)				 ::hscript::ExprDef _g = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 303)				if ((_g->_hx_getIndex() == 2)) {
HXLINE( 303)					::String _g1 = _g->_hx_getString(0);
HXDLIN( 303)					 ::hscript::CType _g2 = _g->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 303)					 ::Dynamic _g3 = _g->_hx_getObject(2);
...
HXLINE( 311)				this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            					->setFixed(0,HX_("t",74,00,00,00),tk)
            					->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            					->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 311)				this->tokenMin = this->oldTokenMin;
HXDLIN( 311)				this->tokenMax = this->oldTokenMax;
            			}
            			else {
...
HXLINE( 346)					this->unexpected(tk);
            		...
            		_hx_goto_33:;
HXLINE( 349)		 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EObject(fl);
HXDLIN( 349)		 ::Dynamic pmin = p1;
HXDLIN( 349)		 ::Dynamic pmax = null();
HXDLIN( 349)		 ::Dynamic _hx_tmp;
HXDLIN( 349)		if (::hx::IsNull( e )) {
HXLINE( 349)			_hx_tmp = null();
            		}
            		else {
HXLINE( 349)			if (::hx::IsNull( pmin )) {
HXLINE( 349)				pmin = this->tokenMin;
            			}
HXDLIN( 349)			if (::hx::IsNull( pmax )) {
HXLINE( 349)				pmax = this->tokenMax;
            			}
HXDLIN( 349)			_hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(5)
            				->setFixed(0,HX_("e",65,00,00,00),e)
            				->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            				->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            				->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 349)		return this->parseExprNext(_hx_tmp);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,parseObject,return )
 ...
 ::Dynamic Parser_obj::parseExpr(){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_352_parseExpr)
HXLINE( 353)		 ::hscript::Token tk = this->token();
HXLINE( 355)		int p1 = this->tokenMin;
HXLINE( 357)		switch((int)(tk->_hx_getIndex())){
            			case (int)1: {
HXLINE( 363)				 ::hscript::Const c = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXLINE( 364)				 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EConst(c);
HXDLIN( 364)				 ::Dynamic pmin = null();
HXDLIN( 364)				 ::Dynamic pmax = null();
HXDLIN( 364)				 ::Dynamic _hx_tmp;
HXDLIN( 364)				if (::hx::IsNull( e )) {
HXLINE( 364)					_hx_tmp = null();
            				}
            				else {
HXLINE( 364)					if (::hx::IsNull( pmin )) {
HXLINE( 364)						pmin = this->tokenMin;
            					}
HXDLIN( 364)					if (::hx::IsNull( pmax )) {
HXLINE( 364)						pmax = this->tokenMax;
            					}
HXDLIN( 364)					_hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(5)
            						->setFixed(0,HX_("e",65,00,00,00),e)
            						->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            						->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            						->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 364)				return this->parseExprNext(_hx_tmp);
            			}
            			break;
            			case (int)2: {
HXLINE( 358)				::String id = tk->_hx_getString(0);
HXLINE( 359)				 ::Dynamic e = this->parseStructure(id);
HXLINE( 360)				if (::hx::IsNull( e )) {
HXLINE( 361)					 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EIdent(id);
HXDLIN( 361)					 ::Dynamic pmin = null();
HXDLIN( 361)					 ::Dynamic pmax = null();
HXDLIN( 361)					if (::hx::IsNull( e1 )) {
HXLINE( 361)						e = null();
            					}
            					else {
...
HXDLIN( 361)						e =  ::Dynamic(::hx::Anon_obj::Create(5)
...
HXLINE( 437)					int start = this->tokenMin;
HXLINE( 438)					 ::Dynamic e = this->parseExpr();
...
HXLINE( 440)						 ::hscript::ExprDef _g = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 440)						if ((_g->_hx_getIndex() == 0)) {
HXLINE( 443)							 ::hscript::Const _g1 = _g->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXDLIN( 443)							switch((int)(_g1->_hx_getIndex())){
            								case (int)0: {
HXLINE( 441)									int i = _g1->_hx_getInt(0);
HXLINE( 442)									 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EConst(::hscript::Const_obj::CInt(-(i)));
HXDLIN( 442)									 ::Dynamic pmin = start;
HXDLIN( 442)									 ::Dynamic pmax;
HXDLIN( 442)									if (::hx::IsNull( e )) {
HXLINE( 442)										pmax = 0;
            									}
            									else {
HXLINE( 442)										pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            									}
HXDLIN( 442)									if (::hx::IsNull( e1 )) {
HXLINE( 442)										return null();
            									}
            									else {
HXLINE( 442)										if (::hx::IsNull( pmin )) {
HXLINE( 442)											pmin = this->tokenMin;
            										}
HXDLIN( 442)										if (::hx::IsNull( pmax )) {
HXLINE( 442)											pmax = this->tokenMax;
            										}
HXDLIN( 442)										return  ::Dynamic(::hx::Anon_obj::Create(5)
            								...
            								break;
            								case (int)1: {
HXLINE( 443)									Float f = _g1->_hx_getFloat(0);
HXLINE( 444)									 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EConst(::hscript::Const_obj::CFloat(-(f)));
HXDLIN( 444)									 ::Dynamic pmin = start;
HXDLIN( 444)									 ::Dynamic pmax;
HXDLIN( 444)									if (::hx::IsNull( e )) {
HXLINE( 444)										pmax = 0;
            									}
            									else {
HXLINE( 444)										pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            									}
HXDLIN( 444)									if (::hx::IsNull( e1 )) {
HXLINE( 444)										return null();
            									}
            									else {
HXLINE( 444)										if (::hx::IsNull( pmin )) {
HXLINE( 444)											pmin = this->tokenMin;
            										}
HXDLIN( 444)										if (::hx::IsNull( pmax )) {
HXLINE( 444)											pmax = this->tokenMax;
            										}
HXDLIN( 444)										return  ::Dynamic(::hx::Anon_obj::Create(5)
            											->setFixed(0,HX_("e",65,00,00,00),e1)
            											->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            											->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            											->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 449)				return this->unexpected(tk);
            			...
            			break;
            			case (int)4: {
HXLINE( 366)				 ::Dynamic e = this->parseExpr();
HXLINE( 367)				tk = this->token();
HXLINE( 368)				switch((int)(tk->_hx_getIndex())){
            					case (int)5: {
HXLINE( 370)						 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EParent(e);
HXDLIN( 370)						 ::Dynamic pmin = p1;
HXDLIN( 370)						 ::Dynamic pmax = this->tokenMax;
HXDLIN( 370)						 ::Dynamic _hx_tmp;
HXDLIN( 370)						if (::hx::IsNull( e1 )) {
HXLINE( 370)							_hx_tmp = null();
            						}
            						else {
HXLINE( 370)							if (::hx::IsNull( pmin )) {
HXLINE( 370)								pmin = this->tokenMin;
            							}
HXDLIN( 370)							if (::hx::IsNull( pmax )) {
HXLINE( 370)								pmax = this->tokenMax;
            							}
HXDLIN( 370)							_hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(5)
            								->setFixed(0,HX_("e",65,00,00,00),e1)
            								->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            								->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            								->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 370)						return this->parseExprNext(_hx_tmp);
            					}
            					break;
            					case (int)9: {
HXLINE( 385)						 ::hscript::ExprDef _g = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 385)						if ((_g->_hx_getIndex() == 1)) {
HXLINE( 386)							::String v = _g->_hx_getString(0);
HXDLIN( 386)							int _hx_tmp;
HXDLIN( 386)							if (::hx::IsNull( e )) {
HXLINE( 386)								_hx_tmp = 0;
            							}
            							else {
HXLINE( 386)								_hx_tmp = ( (int)(e->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) );
            							}
...
HXLINE( 374)						switch((int)(tk->_hx_getIndex())){
            							case (int)5: {
HXLINE( 376)								 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::ECheckType(e,t);
HXDLIN( 376)								 ::Dynamic pmin = p1;
HXDLIN( 376)								 ::Dynamic pmax = this->tokenMax;
HXDLIN( 376)								 ::Dynamic _hx_tmp;
HXDLIN( 376)								if (::hx::IsNull( e1 )) {
...
HXDLIN( 376)								return this->parseExprNext(_hx_tmp);
            							}
            							break;
            							case (int)9: {
HXLINE( 378)								 ::hscript::ExprDef _g = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 378)								if ((_g->_hx_getIndex() == 1)) {
HXLINE( 379)									::String v = _g->_hx_getString(0);
HXDLIN( 379)									int _hx_tmp;
HXDLIN( 379)									if (::hx::IsNull( e )) {
HXLINE( 379)										_hx_tmp = 0;
            									}
            									else {
HXLINE( 379)										_hx_tmp = ( (int)(e->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) );
            									}
...
HXLINE( 411)									{
HXLINE( 411)										this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
...
HXLINE( 415)										return this->parseExprNext(this->parseObject(p1));
            									}
            								}
            							}
            							else {
...
HXLINE( 422)							this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            								->setFixed(0,HX_("t",74,00,00,00),tk)
            								->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            								->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 422)							this->tokenMin = this->oldTokenMin;
HXDLIN( 422)							this->tokenMax = this->oldTokenMax;
            						}
            					}
            					break;
            					case (int)2: {
...
HXLINE( 399)							{
HXLINE( 399)								this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            									->setFixed(0,HX_("t",74,00,00,00),tk2)
            									->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            									->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 399)								this->tokenMin = this->oldTokenMin;
HXDLIN( 399)								this->tokenMax = this->oldTokenMax;
            							}
HXLINE( 400)							{
HXLINE( 400)								this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            									->setFixed(0,HX_("t",74,00,00,00),tk)
            									->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            									->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 400)								this->tokenMin = this->oldTokenMin;
HXDLIN( 400)								this->tokenMax = this->oldTokenMax;
            							}
HXLINE( 401)							if ((tk2->_hx_getIndex() == 14)) {
HXLINE( 403)								return this->parseExprNext(this->parseObject(p1));
            							}
            						}
            					}
            					break;
            					case (int)7: {
HXLINE( 396)						 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EObject(::Array_obj< ::Dynamic>::__new(0));
HXDLIN( 396)						 ::Dynamic pmin = p1;
...
HXDLIN( 396)						return this->parseExprNext(_hx_tmp);
            					}
            					break;
            					default:{
HXLINE( 424)						this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            							->setFixed(0,HX_("t",74,00,00,00),tk)
            							->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            							->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 424)						this->tokenMin = this->oldTokenMin;
HXDLIN( 424)						this->tokenMax = this->oldTokenMax;
            					}
            				}
...
HXLINE( 432)					{
HXLINE( 432)						this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            							->setFixed(0,HX_("t",74,00,00,00),tk)
            							->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            							->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
...
HXDLIN( 432)						this->tokenMax = this->oldTokenMax;
            				...
            				_hx_goto_35:;
HXLINE( 434)				 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EBlock(a);
HXDLIN( 434)				 ::Dynamic pmin = p1;
HXDLIN( 434)				 ::Dynamic pmax = null();
HXDLIN( 434)				if (::hx::IsNull( e )) {
HXLINE( 434)					return null();
            				}
            				else {
HXLINE( 434)					if (::hx::IsNull( pmin )) {
HXLINE( 434)						pmin = this->tokenMin;
            					}
HXDLIN( 434)					if (::hx::IsNull( pmax )) {
HXLINE( 434)						pmax = this->tokenMax;
            					}
HXDLIN( 434)					return  ::Dynamic(::hx::Anon_obj::Create(5)
            						->setFixed(0,HX_("e",65,00,00,00),e)
            						->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            						->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            						->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 454)					{
HXLINE( 454)						this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            							->setFixed(0,HX_("t",74,00,00,00),tk)
            							->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            							->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 454)						this->tokenMin = this->oldTokenMin;
HXDLIN( 454)						this->tokenMax = this->oldTokenMax;
            					}
...
HXLINE( 460)					_hx_tmp = ::hx::IsNotNull( a->__get(0) );
            				}
            				else {
HXLINE( 460)					_hx_tmp = false;
            				}
HXDLIN( 460)				if (_hx_tmp) {
HXLINE( 461)					 ::hscript::ExprDef _g = a->__get(0)->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 461)					switch((int)(_g->_hx_getIndex())){
            						case (int)10: {
HXLINE( 462)							 ::Dynamic _g1 = _g->_hx_getObject(0);
HXDLIN( 462)							 ::Dynamic _g2 = _g->_hx_getObject(1);
HXLINE( 463)							::String tmp = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 465)							 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0));
HXDLIN( 465)							 ::Dynamic pmin = p1;
HXDLIN( 465)							 ::Dynamic pmax = null();
HXDLIN( 465)							 ::Dynamic e1;
HXDLIN( 465)							if (::hx::IsNull( e )) {
HXLINE( 465)								e1 = null();
            							}
            							else {
HXLINE( 465)								if (::hx::IsNull( pmin )) {
HXLINE( 465)									pmin = this->tokenMin;
            								}
HXDLIN( 465)								if (::hx::IsNull( pmax )) {
HXLINE( 465)									pmax = this->tokenMax;
            								}
HXDLIN( 465)								e1 =  ::Dynamic(::hx::Anon_obj::Create(5)
            									->setFixed(0,HX_("e",65,00,00,00),e)
            									->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            									->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            									->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 465)							 ::hscript::ExprDef e2 = ::hscript::ExprDef_obj::EVar(tmp,null(),e1);
HXDLIN( 465)							 ::Dynamic pmin1 = p1;
HXDLIN( 465)							 ::Dynamic pmax1 = null();
HXDLIN( 465)							 ::Dynamic e3;
HXDLIN( 465)							if (::hx::IsNull( e2 )) {
HXLINE( 465)								e3 = null();
            							}
            							else {
HXLINE( 465)								if (::hx::IsNull( pmin1 )) {
HXLINE( 465)									pmin1 = this->tokenMin;
            								}
HXDLIN( 465)								if (::hx::IsNull( pmax1 )) {
HXLINE( 465)									pmax1 = this->tokenMax;
            								}
HXDLIN( 465)								e3 =  ::Dynamic(::hx::Anon_obj::Create(5)
...
HXLINE( 466)							 ::Dynamic e4 = this->mapCompr(tmp,a->__get(0));
HXLINE( 467)							 ::hscript::ExprDef e5 = ::hscript::ExprDef_obj::EIdent(tmp);
HXDLIN( 467)							 ::Dynamic pmin2 = p1;
HXDLIN( 467)							 ::Dynamic pmax2 = null();
HXDLIN( 467)							 ::Dynamic e6;
HXDLIN( 467)							if (::hx::IsNull( e5 )) {
HXLINE( 467)								e6 = null();
            							}
            							else {
HXLINE( 467)								if (::hx::IsNull( pmin2 )) {
HXLINE( 467)									pmin2 = this->tokenMin;
            								}
HXDLIN( 467)								if (::hx::IsNull( pmax2 )) {
HXLINE( 467)									pmax2 = this->tokenMax;
            								}
HXDLIN( 467)								e6 =  ::Dynamic(::hx::Anon_obj::Create(5)
...
HXLINE( 464)							 ::hscript::ExprDef e7 = ::hscript::ExprDef_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,e3)->init(1,e4)->init(2,e6));
HXDLIN( 464)							 ::Dynamic pmin3 = p1;
HXDLIN( 464)							 ::Dynamic pmax3 = null();
HXDLIN( 464)							 ::Dynamic e8;
HXDLIN( 464)							if (::hx::IsNull( e7 )) {
HXLINE( 464)								e8 = null();
            							}
            							else {
HXLINE( 464)								if (::hx::IsNull( pmin3 )) {
HXLINE( 464)									pmin3 = this->tokenMin;
            								}
HXDLIN( 464)								if (::hx::IsNull( pmax3 )) {
HXLINE( 464)									pmax3 = this->tokenMax;
            								}
HXDLIN( 464)								e8 =  ::Dynamic(::hx::Anon_obj::Create(5)
...
HXLINE( 469)							return this->parseExprNext(e8);
            						}
            						break;
            						case (int)11: {
HXLINE( 462)							::String _g1 = _g->_hx_getString(0);
HXDLIN( 462)							 ::Dynamic _g2 = _g->_hx_getObject(1);
HXDLIN( 462)							 ::Dynamic _g3 = _g->_hx_getObject(2);
HXLINE( 463)							::String tmp = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 465)							 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0));
HXDLIN( 465)							 ::Dynamic pmin = p1;
HXDLIN( 465)							 ::Dynamic pmax = null();
...
HXLINE( 472)				 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EArrayDecl(a);
HXDLIN( 472)				 ::Dynamic pmin = p1;
HXDLIN( 472)				 ::Dynamic pmax = null();
HXDLIN( 472)				 ::Dynamic _hx_tmp1;
HXDLIN( 472)				if (::hx::IsNull( e )) {
HXLINE( 472)					_hx_tmp1 = null();
            				}
            				else {
...
HXDLIN( 472)					_hx_tmp1 =  ::Dynamic(::hx::Anon_obj::Create(5)
            						->setFixed(0,HX_("e",65,00,00,00),e)
            						->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            						->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            						->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 472)				return this->parseExprNext(_hx_tmp1);
            			}
            			break;
            			case (int)15: {
...
HXLINE( 475)					 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EMeta(id,args,this->parseExpr());
HXDLIN( 475)					 ::Dynamic pmin = p1;
HXDLIN( 475)					 ::Dynamic pmax = null();
HXDLIN( 475)					if (::hx::IsNull( e )) {
HXLINE( 475)						return null();
            					}
            					else {
HXLINE( 475)						if (::hx::IsNull( pmin )) {
HXLINE( 475)							pmin = this->tokenMin;
            						}
HXDLIN( 475)						if (::hx::IsNull( pmax )) {
HXLINE( 475)							pmax = this->tokenMax;
            						}
HXDLIN( 475)						return  ::Dynamic(::hx::Anon_obj::Create(5)
            							->setFixed(0,HX_("e",65,00,00,00),e)
            							->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            							->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            							->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 497)		 ::Dynamic eret = this->parseExpr();
HXLINE( 498)		 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EReturn(eret);
HXDLIN( 498)		 ::Dynamic pmin1 = pmin;
HXDLIN( 498)		 ::Dynamic pmax = null();
HXDLIN( 498)		 ::Dynamic e1;
HXDLIN( 498)		if (::hx::IsNull( e )) {
HXLINE( 498)			e1 = null();
            		}
            		else {
HXLINE( 498)			if (::hx::IsNull( pmin1 )) {
HXLINE( 498)				pmin1 = this->tokenMin;
            			}
HXDLIN( 498)			if (::hx::IsNull( pmax )) {
HXLINE( 498)				pmax = this->tokenMax;
            			}
HXDLIN( 498)			e1 =  ::Dynamic(::hx::Anon_obj::Create(5)
            				->setFixed(0,HX_("e",65,00,00,00),e)
            				->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            				->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            				->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin1)
...
HXDLIN( 498)		 ::hscript::ExprDef e2 = ::hscript::ExprDef_obj::EFunction(args,e1,null(),null());
HXDLIN( 498)		 ::Dynamic pmin2 = pmin;
HXDLIN( 498)		 ::Dynamic pmax1 = null();
HXDLIN( 498)		if (::hx::IsNull( e2 )) {
HXLINE( 498)			return null();
            		}
            		else {
HXLINE( 498)			if (::hx::IsNull( pmin2 )) {
HXLINE( 498)				pmin2 = this->tokenMin;
            			}
HXDLIN( 498)			if (::hx::IsNull( pmax1 )) {
HXLINE( 498)				pmax1 = this->tokenMax;
            			}
HXDLIN( 498)			return  ::Dynamic(::hx::Anon_obj::Create(5)
            				->setFixed(0,HX_("e",65,00,00,00),e2)
            				->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            				->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax1)
            				->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin2)
...
::Array< ::Dynamic> Parser_obj::parseMetaArgs(){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_501_parseMetaArgs)
...
HXLINE( 510)			{
HXLINE( 510)				this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            					->setFixed(0,HX_("t",74,00,00,00),tk)
            					->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            					->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 510)				this->tokenMin = this->oldTokenMin;
HXDLIN( 510)				this->tokenMax = this->oldTokenMax;
            			}
HXLINE( 511)			while(true){
HXLINE( 512)				args->push(this->parseExpr());
HXLINE( 513)				{
HXLINE( 513)					 ::hscript::Token _g = this->token();
HXDLIN( 513)					switch((int)(_g->_hx_getIndex())){
            						case (int)5: {
...
HXLINE( 527)		 ::hscript::ExprDef edef;
HXDLIN( 527)		 ::hscript::ExprDef _g = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 527)		switch((int)(_g->_hx_getIndex())){
            			case (int)3: {
HXLINE( 538)				 ::Dynamic e2 = _g->_hx_getObject(0);
HXLINE( 527)				edef = ::hscript::ExprDef_obj::EParent(this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)4: {
HXLINE( 536)				::Array< ::Dynamic> _g1 = _g->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 536)				if ((_g1->length == 1)) {
HXLINE( 536)					 ::Dynamic e = _g1->__get(0);
HXLINE( 527)					edef = ::hscript::ExprDef_obj::EBlock(::Array_obj< ::Dynamic>::__new(1)->init(0,this->mapCompr(tmp,e)));
            				}
            				else {
HXLINE( 541)					 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EIdent(tmp);
HXDLIN( 541)					 ::Dynamic pmin;
HXDLIN( 541)					if (::hx::IsNull( e )) {
HXLINE( 541)						pmin = 0;
            					}
            					else {
HXLINE( 541)						pmin = e->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 541)					 ::Dynamic pmax;
HXDLIN( 541)					if (::hx::IsNull( e )) {
HXLINE( 541)						pmax = 0;
            					}
            					else {
HXLINE( 541)						pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 541)					 ::Dynamic e2;
HXDLIN( 541)					if (::hx::IsNull( e1 )) {
HXLINE( 541)						e2 = null();
            					}
            					else {
HXLINE( 541)						if (::hx::IsNull( pmin )) {
HXLINE( 541)							pmin = this->tokenMin;
            						}
HXDLIN( 541)						if (::hx::IsNull( pmax )) {
HXLINE( 541)							pmax = this->tokenMax;
            						}
HXDLIN( 541)						e2 =  ::Dynamic(::hx::Anon_obj::Create(5)
            							->setFixed(0,HX_("e",65,00,00,00),e1)
            							->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            							->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            							->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 541)					 ::hscript::ExprDef e3 = ::hscript::ExprDef_obj::EField(e2,HX_("push",da,11,61,4a));
HXDLIN( 541)					 ::Dynamic pmin1;
HXDLIN( 541)					if (::hx::IsNull( e )) {
HXLINE( 541)						pmin1 = 0;
            					}
            					else {
HXLINE( 541)						pmin1 = e->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 541)					 ::Dynamic pmax1;
HXDLIN( 541)					if (::hx::IsNull( e )) {
HXLINE( 541)						pmax1 = 0;
            					}
            					else {
HXLINE( 541)						pmax1 = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 541)					 ::Dynamic edef1;
HXDLIN( 541)					if (::hx::IsNull( e3 )) {
HXLINE( 541)						edef1 = null();
            					}
            					else {
HXLINE( 541)						if (::hx::IsNull( pmin1 )) {
HXLINE( 541)							pmin1 = this->tokenMin;
            						}
HXDLIN( 541)						if (::hx::IsNull( pmax1 )) {
HXLINE( 541)							pmax1 = this->tokenMax;
            						}
HXDLIN( 541)						edef1 =  ::Dynamic(::hx::Anon_obj::Create(5)
...
HXLINE( 527)					edef = ::hscript::ExprDef_obj::ECall(edef1,::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            				}
            			}
            			break;
            			case (int)9: {
HXLINE( 534)				 ::Dynamic cond = _g->_hx_getObject(0);
HXDLIN( 534)				 ::Dynamic e1 = _g->_hx_getObject(1);
HXDLIN( 534)				 ::Dynamic e2 = _g->_hx_getObject(2);
HXDLIN( 534)				if (::hx::IsNull( e2 )) {
HXLINE( 527)					edef = ::hscript::ExprDef_obj::EIf(cond,this->mapCompr(tmp,e1),null());
            				}
            				else {
HXLINE( 541)					 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EIdent(tmp);
HXDLIN( 541)					 ::Dynamic pmin;
...
HXDLIN( 530)				 ::Dynamic e2 = _g->_hx_getObject(1);
HXLINE( 527)				edef = ::hscript::ExprDef_obj::EWhile(cond,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)11: {
HXLINE( 528)				::String v = _g->_hx_getString(0);
HXDLIN( 528)				 ::Dynamic it = _g->_hx_getObject(1);
HXDLIN( 528)				 ::Dynamic e2 = _g->_hx_getObject(2);
HXLINE( 527)				edef = ::hscript::ExprDef_obj::EFor(v,it,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)24: {
HXLINE( 532)				 ::Dynamic cond = _g->_hx_getObject(0);
HXDLIN( 532)				 ::Dynamic e2 = _g->_hx_getObject(1);
HXLINE( 527)				edef = ::hscript::ExprDef_obj::EDoWhile(cond,this->mapCompr(tmp,e2));
            			}
            			break;
            			default:{
HXLINE( 541)				 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EIdent(tmp);
...
HXLINE( 543)		 ::Dynamic pmin;
HXDLIN( 543)		if (::hx::IsNull( e )) {
HXLINE( 543)			pmin = 0;
            		}
            		else {
HXLINE( 543)			pmin = e->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            		}
HXDLIN( 543)		 ::Dynamic pmax;
HXDLIN( 543)		if (::hx::IsNull( e )) {
HXLINE( 543)			pmax = 0;
            		}
            		else {
HXLINE( 543)			pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            		}
HXDLIN( 543)		if (::hx::IsNull( edef )) {
HXLINE( 543)			return null();
            		}
            		else {
HXLINE( 543)			if (::hx::IsNull( pmin )) {
HXLINE( 543)				pmin = this->tokenMin;
            			}
HXDLIN( 543)			if (::hx::IsNull( pmax )) {
HXLINE( 543)				pmax = this->tokenMax;
            			}
HXDLIN( 543)			return  ::Dynamic(::hx::Anon_obj::Create(5)
...
HXLINE( 549)		 ::hscript::ExprDef _g = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 549)		switch((int)(_g->_hx_getIndex())){
            			case (int)6: {
HXLINE( 550)				::String bop = _g->_hx_getString(0);
HXDLIN( 550)				 ::Dynamic e1 = _g->_hx_getObject(1);
HXDLIN( 550)				 ::Dynamic e2 = _g->_hx_getObject(2);
HXDLIN( 550)				 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EBinop(bop,this->makeUnop(op,e1),e2);
HXDLIN( 550)				 ::Dynamic pmin;
HXDLIN( 550)				if (::hx::IsNull( e1 )) {
HXLINE( 550)					pmin = 0;
            				}
            				else {
HXLINE( 550)					pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            				}
HXDLIN( 550)				 ::Dynamic pmax;
HXDLIN( 550)				if (::hx::IsNull( e2 )) {
HXLINE( 550)					pmax = 0;
            				}
            				else {
HXLINE( 550)					pmax = e2->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            				}
...
HXDLIN( 550)					return  ::Dynamic(::hx::Anon_obj::Create(5)
            			...
            			break;
            			case (int)22: {
HXLINE( 551)				 ::Dynamic e1 = _g->_hx_getObject(0);
HXDLIN( 551)				 ::Dynamic e2 = _g->_hx_getObject(1);
HXDLIN( 551)				 ::Dynamic e3 = _g->_hx_getObject(2);
HXDLIN( 551)				 ::hscript::ExprDef e = ::hscript::ExprDef_obj::ETernary(this->makeUnop(op,e1),e2,e3);
HXDLIN( 551)				 ::Dynamic pmin;
HXDLIN( 551)				if (::hx::IsNull( e1 )) {
HXLINE( 551)					pmin = 0;
            				}
            				else {
HXLINE( 551)					pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            				}
HXDLIN( 551)				 ::Dynamic pmax;
HXDLIN( 551)				if (::hx::IsNull( e3 )) {
HXLINE( 551)					pmax = 0;
            				}
            				else {
HXLINE( 551)					pmax = e3->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            				}
HXDLIN( 551)				if (::hx::IsNull( e )) {
HXLINE( 551)					return null();
            				}
            				else {
HXLINE( 551)					if (::hx::IsNull( pmin )) {
HXLINE( 551)						pmin = this->tokenMin;
            					}
HXDLIN( 551)					if (::hx::IsNull( pmax )) {
HXLINE( 551)						pmax = this->tokenMax;
            					}
HXDLIN( 551)					return  ::Dynamic(::hx::Anon_obj::Create(5)
            			...
            			break;
            			default:{
HXLINE( 552)				 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EUnop(op,true,e);
HXDLIN( 552)				 ::Dynamic pmin;
HXDLIN( 552)				if (::hx::IsNull( e )) {
HXLINE( 552)					pmin = 0;
            				}
            				else {
HXLINE( 552)					pmin = e->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            				}
HXDLIN( 552)				 ::Dynamic pmax;
HXDLIN( 552)				if (::hx::IsNull( e )) {
HXLINE( 552)					pmax = 0;
            				}
            				else {
HXLINE( 552)					pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            				}
HXDLIN( 552)				if (::hx::IsNull( e1 )) {
HXLINE( 552)					return null();
            				}
            				else {
HXLINE( 552)					if (::hx::IsNull( pmin )) {
HXLINE( 552)						pmin = this->tokenMin;
            					}
HXDLIN( 552)					if (::hx::IsNull( pmax )) {
HXLINE( 552)						pmax = this->tokenMax;
            					}
HXDLIN( 552)					return  ::Dynamic(::hx::Anon_obj::Create(5)
            						->setFixed(0,HX_("e",65,00,00,00),e1)
            						->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            						->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            						->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 558)			 ::hscript::ExprDef e2 = ::hscript::ExprDef_obj::EBinop(op,e1,e);
...
HXLINE( 558)				pmax = e1->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            			}
HXDLIN( 558)			if (::hx::IsNull( e2 )) {
...
HXLINE( 559)		 ::hscript::ExprDef _g = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 559)		switch((int)(_g->_hx_getIndex())){
            			case (int)6: {
HXLINE( 560)				::String op2 = _g->_hx_getString(0);
HXDLIN( 560)				 ::Dynamic e2 = _g->_hx_getObject(1);
HXDLIN( 560)				 ::Dynamic e3 = _g->_hx_getObject(2);
...
HXLINE( 562)					 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EBinop(op2,this->makeBinop(op,e1,e2),e3);
HXDLIN( 562)					 ::Dynamic pmin;
HXDLIN( 562)					if (::hx::IsNull( e1 )) {
HXLINE( 562)						pmin = 0;
            					}
            					else {
HXLINE( 562)						pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 562)					 ::Dynamic pmax;
HXDLIN( 562)					if (::hx::IsNull( e3 )) {
HXLINE( 562)						pmax = 0;
            					}
            					else {
HXLINE( 562)						pmax = e3->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 562)					if (::hx::IsNull( e )) {
HXLINE( 562)						return null();
            					}
            					else {
HXLINE( 562)						if (::hx::IsNull( pmin )) {
HXLINE( 562)							pmin = this->tokenMin;
            						}
HXDLIN( 562)						if (::hx::IsNull( pmax )) {
HXLINE( 562)							pmax = this->tokenMax;
            						}
HXDLIN( 562)						return  ::Dynamic(::hx::Anon_obj::Create(5)
            							->setFixed(0,HX_("e",65,00,00,00),e)
            							->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            							->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            							->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 564)					 ::hscript::ExprDef e2 = ::hscript::ExprDef_obj::EBinop(op,e1,e);
HXDLIN( 564)					 ::Dynamic pmin;
HXDLIN( 564)					if (::hx::IsNull( e1 )) {
HXLINE( 564)						pmin = 0;
            					}
            					else {
HXLINE( 564)						pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 564)					 ::Dynamic pmax;
HXDLIN( 564)					if (::hx::IsNull( e )) {
HXLINE( 564)						pmax = 0;
            					}
            					else {
HXLINE( 564)						pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 564)					if (::hx::IsNull( e2 )) {
HXLINE( 564)						return null();
            					}
            					else {
HXLINE( 564)						if (::hx::IsNull( pmin )) {
HXLINE( 564)							pmin = this->tokenMin;
            						}
HXDLIN( 564)						if (::hx::IsNull( pmax )) {
HXLINE( 564)							pmax = this->tokenMax;
            						}
HXDLIN( 564)						return  ::Dynamic(::hx::Anon_obj::Create(5)
            							->setFixed(0,HX_("e",65,00,00,00),e2)
            							->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            							->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            							->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
            			...
            			break;
            			case (int)22: {
HXLINE( 565)				 ::Dynamic e2 = _g->_hx_getObject(0);
HXDLIN( 565)				 ::Dynamic e3 = _g->_hx_getObject(1);
HXDLIN( 565)				 ::Dynamic e4 = _g->_hx_getObject(2);
HXLINE( 566)				if (this->opRightAssoc->exists(op)) {
HXLINE( 567)					 ::hscript::ExprDef e2 = ::hscript::ExprDef_obj::EBinop(op,e1,e);
HXDLIN( 567)					 ::Dynamic pmin;
HXDLIN( 567)					if (::hx::IsNull( e1 )) {
HXLINE( 567)						pmin = 0;
            					}
            					else {
HXLINE( 567)						pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 567)					 ::Dynamic pmax;
HXDLIN( 567)					if (::hx::IsNull( e )) {
HXLINE( 567)						pmax = 0;
            					}
            					else {
HXLINE( 567)						pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 567)					if (::hx::IsNull( e2 )) {
...
HXLINE( 569)					 ::hscript::ExprDef e5 = ::hscript::ExprDef_obj::ETernary(this->makeBinop(op,e1,e2),e3,e4);
...
HXLINE( 569)						pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 569)					if (::hx::IsNull( e5 )) {
...
HX_DEFINE_DYNAMIC_FUNC3(Parser_obj,makeBinop,return )
 ...
 ::Dynamic Parser_obj::parseStructure(::String id){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_575_parseStructure)
HXLINE( 577)		int p1 = this->tokenMin;
HXLINE( 579)		::String _hx_switch_0 = id;
            		if (  (_hx_switch_0==HX_("break",bf,24,ec,b8)) ){
HXLINE( 635)			 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EBreak_dyn();
HXDLIN( 635)			 ::Dynamic pmin = null();
HXDLIN( 635)			 ::Dynamic pmax = null();
HXDLIN( 635)			if (::hx::IsNull( e )) {
HXLINE( 635)				return null();
            			}
            			else {
HXLINE( 635)				if (::hx::IsNull( pmin )) {
HXLINE( 635)					pmin = this->tokenMin;
            				}
HXDLIN( 635)				if (::hx::IsNull( pmax )) {
HXLINE( 635)					pmax = this->tokenMax;
            				}
HXDLIN( 635)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 636)			 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EContinue_dyn();
HXDLIN( 636)			 ::Dynamic pmin = null();
HXDLIN( 636)			 ::Dynamic pmax = null();
...
HXDLIN( 636)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 618)			 ::Dynamic e = this->parseExpr();
...
HXLINE( 625)			 ::Dynamic econd = this->parseExpr();
HXLINE( 626)			 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EDoWhile(econd,e);
HXDLIN( 626)			 ::Dynamic pmin = p1;
HXDLIN( 626)			 ::Dynamic pmax;
HXDLIN( 626)			if (::hx::IsNull( econd )) {
HXLINE( 626)				pmax = 0;
            			}
            			else {
HXLINE( 626)				pmax = econd->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            			}
HXDLIN( 626)			if (::hx::IsNull( e1 )) {
HXLINE( 626)				return null();
            			}
            			else {
HXLINE( 626)				if (::hx::IsNull( pmin )) {
HXLINE( 626)					pmin = this->tokenMin;
            				}
HXDLIN( 626)				if (::hx::IsNull( pmax )) {
HXLINE( 626)					pmax = this->tokenMax;
            				}
HXDLIN( 626)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e1)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 631)			 ::Dynamic eiter = this->parseExpr();
HXLINE( 632)			{
...
HXLINE( 633)			 ::Dynamic e = this->parseExpr();
HXLINE( 634)			 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EFor(vname,eiter,e);
HXDLIN( 634)			 ::Dynamic pmin = p1;
HXDLIN( 634)			 ::Dynamic pmax;
HXDLIN( 634)			if (::hx::IsNull( e )) {
HXLINE( 634)				pmax = 0;
            			}
            			else {
HXLINE( 634)				pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            			}
HXDLIN( 634)			if (::hx::IsNull( e1 )) {
HXLINE( 634)				return null();
            			}
            			else {
HXLINE( 634)				if (::hx::IsNull( pmin )) {
HXLINE( 634)					pmin = this->tokenMin;
            				}
HXDLIN( 634)				if (::hx::IsNull( pmax )) {
HXLINE( 634)					pmax = this->tokenMax;
            				}
HXDLIN( 634)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e1)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 646)				this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            					->setFixed(0,HX_("t",74,00,00,00),tk)
            					->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            					->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 646)				this->tokenMin = this->oldTokenMin;
HXDLIN( 646)				this->tokenMax = this->oldTokenMax;
            			}
HXLINE( 648)			 ::Dynamic inf = this->parseFunctionDecl();
HXLINE( 649)			 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EFunction( ::Dynamic(inf->__Field(HX_("args",5d,8d,74,40),::hx::paccDynamic)), ::Dynamic(inf->__Field(HX_("body",a2,7a,1b,41),::hx::paccDynamic)),name, ::Dynamic(inf->__Field(HX_("ret",61,d9,56,00),::hx::paccDynamic)));
HXDLIN( 649)			 ::Dynamic pmin = p1;
HXDLIN( 649)			 ::Dynamic e1 = inf->__Field(HX_("body",a2,7a,1b,41),::hx::paccDynamic);
HXDLIN( 649)			 ::Dynamic pmax;
HXDLIN( 649)			if (::hx::IsNull( e1 )) {
HXLINE( 649)				pmax = 0;
            			}
            			else {
HXLINE( 649)				pmax = e1->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            			}
HXDLIN( 649)			if (::hx::IsNull( e )) {
HXLINE( 649)				return null();
            			}
            			else {
HXLINE( 649)				if (::hx::IsNull( pmin )) {
HXLINE( 649)					pmin = this->tokenMin;
            				}
HXDLIN( 649)				if (::hx::IsNull( pmax )) {
HXLINE( 649)					pmax = this->tokenMax;
            				}
HXDLIN( 649)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 582)			 ::Dynamic cond = this->parseExpr();
HXLINE( 583)			{
...
HXLINE( 584)			 ::Dynamic e1 = this->parseExpr();
HXLINE( 585)			 ::Dynamic e2 = null();
...
HXLINE( 595)				{
HXLINE( 595)					this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            						->setFixed(0,HX_("t",74,00,00,00),tk)
            						->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            						->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 595)					this->tokenMin = this->oldTokenMin;
HXDLIN( 595)					this->tokenMax = this->oldTokenMax;
            				}
HXLINE( 596)				if (semic) {
HXLINE( 596)					this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            						->setFixed(0,HX_("t",74,00,00,00),::hscript::Token_obj::TSemicolon_dyn())
            						->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            						->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 596)					this->tokenMin = this->oldTokenMin;
HXDLIN( 596)					this->tokenMax = this->oldTokenMax;
            				}
            			}
HXLINE( 598)			 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EIf(cond,e1,e2);
HXDLIN( 598)			 ::Dynamic pmin = p1;
HXDLIN( 598)			 ::Dynamic pmax;
HXDLIN( 598)			if (::hx::IsNull( e2 )) {
HXLINE( 598)				pmax = this->tokenMax;
            			}
            			else {
HXLINE( 598)				if (::hx::IsNull( e2 )) {
HXLINE( 598)					pmax = 0;
            				}
            				else {
HXLINE( 598)					pmax = e2->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            				}
            			}
...
HXLINE( 598)				if (::hx::IsNull( pmin )) {
HXLINE( 598)					pmin = this->tokenMin;
            				}
HXDLIN( 598)				if (::hx::IsNull( pmax )) {
HXLINE( 598)					pmax = this->tokenMax;
            				}
HXDLIN( 598)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 671)			 ::hscript::ExprDef e = ::hscript::ExprDef_obj::ENew(a->join(HX_(".",2e,00,00,00)),args);
HXDLIN( 671)			 ::Dynamic pmin = p1;
HXDLIN( 671)			 ::Dynamic pmax = null();
HXDLIN( 671)			if (::hx::IsNull( e )) {
HXLINE( 671)				return null();
            			}
            			else {
HXLINE( 671)				if (::hx::IsNull( pmin )) {
HXLINE( 671)					pmin = this->tokenMin;
            				}
HXDLIN( 671)				if (::hx::IsNull( pmax )) {
HXLINE( 671)					pmax = this->tokenMax;
            				}
HXDLIN( 671)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 652)			{
HXLINE( 652)				this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            					->setFixed(0,HX_("t",74,00,00,00),tk)
            					->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            					->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 652)				this->tokenMin = this->oldTokenMin;
HXDLIN( 652)				this->tokenMax = this->oldTokenMax;
            			}
HXLINE( 653)			 ::Dynamic e;
...
HXLINE( 654)			 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EReturn(e);
HXDLIN( 654)			 ::Dynamic pmin = p1;
HXDLIN( 654)			 ::Dynamic pmax;
HXDLIN( 654)			if (::hx::IsNull( e )) {
HXLINE( 654)				pmax = this->tokenMax;
            			}
            			else {
HXLINE( 654)				if (::hx::IsNull( e )) {
HXLINE( 654)					pmax = 0;
            				}
            				else {
HXLINE( 654)					pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            				}
            			}
HXDLIN( 654)			if (::hx::IsNull( e1 )) {
HXLINE( 654)				return null();
            			}
            			else {
HXLINE( 654)				if (::hx::IsNull( pmin )) {
HXLINE( 654)					pmin = this->tokenMin;
            				}
HXDLIN( 654)				if (::hx::IsNull( pmax )) {
HXLINE( 654)					pmax = this->tokenMax;
            				}
HXDLIN( 654)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e1)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 690)			 ::Dynamic e = this->parseExpr();
HXLINE( 691)			 ::Dynamic def = null();
...
HXLINE( 700)								 ::Dynamic e = this->parseExpr();
...
HXLINE( 716)								{
HXLINE( 716)									this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            										->setFixed(0,HX_("t",74,00,00,00),tk)
            										->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            										->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 716)									this->tokenMin = this->oldTokenMin;
HXDLIN( 716)									this->tokenMax = this->oldTokenMax;
            								}
...
HXLINE( 723)										this->parseFullExpr(exprs);
            							...
            							_hx_goto_50:;
HXLINE( 726)							 ::Dynamic _hx_tmp;
HXDLIN( 726)							if ((exprs->length == 1)) {
HXLINE( 726)								_hx_tmp = exprs->__get(0);
            							}
            							else {
HXLINE( 728)								if ((exprs->length == 0)) {
HXLINE( 729)									 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EBlock(::Array_obj< ::Dynamic>::__new(0));
HXDLIN( 729)									 ::Dynamic pmin = this->tokenMin;
HXDLIN( 729)									 ::Dynamic pmax = this->tokenMin;
HXDLIN( 729)									if (::hx::IsNull( e )) {
HXLINE( 726)										_hx_tmp = null();
            									}
            									else {
HXLINE( 729)										if (::hx::IsNull( pmin )) {
HXLINE( 729)											pmin = this->tokenMin;
            										}
HXDLIN( 729)										if (::hx::IsNull( pmax )) {
HXLINE( 729)											pmax = this->tokenMax;
            										}
HXLINE( 726)										_hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(5)
            											->setFixed(0,HX_("e",65,00,00,00),e)
            											->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            											->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            											->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 731)									 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EBlock(exprs);
HXDLIN( 731)									 ::Dynamic e1 = exprs->__get(0);
HXDLIN( 731)									 ::Dynamic pmin;
HXDLIN( 731)									if (::hx::IsNull( e1 )) {
HXLINE( 731)										pmin = 0;
            									}
            									else {
HXLINE( 731)										pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            									}
HXDLIN( 731)									 ::Dynamic e2 = exprs->__get((exprs->length - 1));
HXDLIN( 731)									 ::Dynamic pmax;
HXDLIN( 731)									if (::hx::IsNull( e2 )) {
HXLINE( 731)										pmax = 0;
            									}
            									else {
HXLINE( 731)										pmax = e2->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            									}
HXDLIN( 731)									if (::hx::IsNull( e )) {
HXLINE( 726)										_hx_tmp = null();
            									}
            									else {
HXLINE( 731)										if (::hx::IsNull( pmin )) {
HXLINE( 731)											pmin = this->tokenMin;
            										}
HXDLIN( 731)										if (::hx::IsNull( pmax )) {
HXLINE( 731)											pmax = this->tokenMax;
            										}
HXLINE( 726)										_hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(5)
            											->setFixed(0,HX_("e",65,00,00,00),e)
            											->setFixed(1,HX_("line",f4,17,b3,47),this->line)
...
HXLINE( 738)								{
HXLINE( 738)									this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            										->setFixed(0,HX_("t",74,00,00,00),tk)
            										->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            										->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 738)									this->tokenMin = this->oldTokenMin;
HXDLIN( 738)									this->tokenMax = this->oldTokenMax;
            								}
...
HXLINE( 749)								def = exprs->__get(0);
            							}
            							else {
HXLINE( 750)								if ((exprs->length == 0)) {
HXLINE( 751)									 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EBlock(::Array_obj< ::Dynamic>::__new(0));
HXDLIN( 751)									 ::Dynamic pmin = this->tokenMin;
HXDLIN( 751)									 ::Dynamic pmax = this->tokenMin;
HXDLIN( 751)									if (::hx::IsNull( e )) {
HXLINE( 751)										def = null();
            									}
            									else {
...
HXDLIN( 751)										def =  ::Dynamic(::hx::Anon_obj::Create(5)
            											->setFixed(0,HX_("e",65,00,00,00),e)
            											->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            											->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            											->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 753)									 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EBlock(exprs);
HXDLIN( 753)									 ::Dynamic e1 = exprs->__get(0);
HXDLIN( 753)									 ::Dynamic pmin;
HXDLIN( 753)									if (::hx::IsNull( e1 )) {
HXLINE( 753)										pmin = 0;
            									}
            									else {
HXLINE( 753)										pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            									}
HXDLIN( 753)									 ::Dynamic e2 = exprs->__get((exprs->length - 1));
HXDLIN( 753)									 ::Dynamic pmax;
HXDLIN( 753)									if (::hx::IsNull( e2 )) {
HXLINE( 753)										pmax = 0;
            									}
            									else {
HXLINE( 753)										pmax = e2->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            									}
HXDLIN( 753)									if (::hx::IsNull( e )) {
HXLINE( 753)										def = null();
            									}
            									else {
...
HXDLIN( 753)										def =  ::Dynamic(::hx::Anon_obj::Create(5)
            											->setFixed(0,HX_("e",65,00,00,00),e)
            											->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            											->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            											->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 758)						goto _hx_goto_47;
            			...
            			_hx_goto_47:;
HXLINE( 761)			 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::ESwitch(e,cases,def);
HXDLIN( 761)			 ::Dynamic pmin = p1;
HXDLIN( 761)			 ::Dynamic pmax = this->tokenMax;
HXDLIN( 761)			if (::hx::IsNull( e1 )) {
HXLINE( 761)				return null();
            			}
            			else {
HXLINE( 761)				if (::hx::IsNull( pmin )) {
HXLINE( 761)					pmin = this->tokenMin;
            				}
HXDLIN( 761)				if (::hx::IsNull( pmax )) {
HXLINE( 761)					pmax = this->tokenMax;
            				}
HXDLIN( 761)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e1)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 673)			 ::Dynamic e = this->parseExpr();
HXLINE( 674)			 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EThrow(e);
HXDLIN( 674)			 ::Dynamic pmin = p1;
HXDLIN( 674)			 ::Dynamic pmax;
HXDLIN( 674)			if (::hx::IsNull( e )) {
HXLINE( 674)				pmax = 0;
            			}
            			else {
HXLINE( 674)				pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            			}
HXDLIN( 674)			if (::hx::IsNull( e1 )) {
HXLINE( 674)				return null();
            			}
            			else {
HXLINE( 674)				if (::hx::IsNull( pmin )) {
HXLINE( 674)					pmin = this->tokenMin;
            				}
HXDLIN( 674)				if (::hx::IsNull( pmax )) {
HXLINE( 674)					pmax = this->tokenMax;
            				}
HXDLIN( 674)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e1)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 676)			 ::Dynamic e = this->parseExpr();
HXLINE( 677)			{
...
HXLINE( 687)			 ::Dynamic ec = this->parseExpr();
HXLINE( 688)			 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::ETry(e,vname,t3,ec);
HXDLIN( 688)			 ::Dynamic pmin = p1;
HXDLIN( 688)			 ::Dynamic pmax;
HXDLIN( 688)			if (::hx::IsNull( ec )) {
HXLINE( 688)				pmax = 0;
            			}
            			else {
HXLINE( 688)				pmax = ec->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            			}
HXDLIN( 688)			if (::hx::IsNull( e1 )) {
HXLINE( 688)				return null();
            			}
            			else {
HXLINE( 688)				if (::hx::IsNull( pmin )) {
HXLINE( 688)					pmin = this->tokenMin;
            				}
HXDLIN( 688)				if (::hx::IsNull( pmax )) {
HXLINE( 688)					pmax = this->tokenMax;
            				}
HXDLIN( 688)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e1)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE( 607)			 ::Dynamic e = null();
HXLINE( 608)			if (__hxcpp_enum_eq(tk,::hscript::Token_obj::TOp(HX_("=",3d,00,00,00)))) {
HXLINE( 609)				e = this->parseExpr();
            			}
            			else {
HXLINE( 611)				this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            					->setFixed(0,HX_("t",74,00,00,00),tk)
            					->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            					->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 611)				this->tokenMin = this->oldTokenMin;
HXDLIN( 611)				this->tokenMax = this->oldTokenMax;
            			}
HXLINE( 612)			 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EVar(ident,t,e);
HXDLIN( 612)			 ::Dynamic pmin = p1;
HXDLIN( 612)			 ::Dynamic pmax;
HXDLIN( 612)			if (::hx::IsNull( e )) {
HXLINE( 612)				pmax = this->tokenMax;
            			}
            			else {
HXLINE( 612)				if (::hx::IsNull( e )) {
HXLINE( 612)					pmax = 0;
            				}
            				else {
HXLINE( 612)					pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            				}
            			}
HXDLIN( 612)			if (::hx::IsNull( e1 )) {
HXLINE( 612)				return null();
            			}
            			else {
HXLINE( 612)				if (::hx::IsNull( pmin )) {
HXLINE( 612)					pmin = this->tokenMin;
            				}
HXDLIN( 612)				if (::hx::IsNull( pmax )) {
HXLINE( 612)					pmax = this->tokenMax;
            				}
...
HXLINE( 614)			 ::Dynamic econd = this->parseExpr();
HXLINE( 615)			 ::Dynamic e = this->parseExpr();
HXLINE( 616)			 ::hscript::ExprDef e1 = ::hscript::ExprDef_obj::EWhile(econd,e);
HXDLIN( 616)			 ::Dynamic pmin = p1;
HXDLIN( 616)			 ::Dynamic pmax;
HXDLIN( 616)			if (::hx::IsNull( e )) {
HXLINE( 616)				pmax = 0;
            			}
            			else {
HXLINE( 616)				pmax = e->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            			}
HXDLIN( 616)			if (::hx::IsNull( e1 )) {
HXLINE( 616)				return null();
            			}
            			else {
HXLINE( 616)				if (::hx::IsNull( pmin )) {
HXLINE( 616)					pmin = this->tokenMin;
            				}
HXDLIN( 616)				if (::hx::IsNull( pmax )) {
HXLINE( 616)					pmax = this->tokenMax;
            				}
HXDLIN( 616)				return  ::Dynamic(::hx::Anon_obj::Create(5)
            					->setFixed(0,HX_("e",65,00,00,00),e1)
            					->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            					->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            					->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,parseStructure,return )
 ...
 ::Dynamic Parser_obj::parseExprNext( ::Dynamic e1){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_767_parseExprNext)
...
HXLINE( 774)					{
HXLINE( 774)						 ::hscript::ExprDef _g = e1->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 774)						switch((int)(_g->_hx_getIndex())){
            							case (int)1: {
HXLINE( 775)								::String i = _g->_hx_getString(0);
HXLINE( 776)								 ::Dynamic eret = this->parseExpr();
HXLINE( 777)								 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EReturn(eret);
HXDLIN( 777)								 ::Dynamic pmin;
HXDLIN( 777)								if (::hx::IsNull( eret )) {
HXLINE( 777)									pmin = 0;
            								}
            								else {
HXLINE( 777)									pmin = eret->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            								}
HXDLIN( 777)								 ::Dynamic pmax = null();
HXDLIN( 777)								 ::Dynamic e2;
HXDLIN( 777)								if (::hx::IsNull( e )) {
HXLINE( 777)									e2 = null();
            								}
            								else {
HXLINE( 777)									if (::hx::IsNull( pmin )) {
HXLINE( 777)										pmin = this->tokenMin;
            									}
HXDLIN( 777)									if (::hx::IsNull( pmax )) {
HXLINE( 777)										pmax = this->tokenMax;
            									}
HXDLIN( 777)									e2 =  ::Dynamic(::hx::Anon_obj::Create(5)
            										->setFixed(0,HX_("e",65,00,00,00),e)
            										->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            										->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            										->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 777)								 ::hscript::ExprDef e3 = ::hscript::ExprDef_obj::EFunction(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(1)
            									->setFixed(0,HX_("name",4b,72,ff,48),i))),e2,null(),null());
HXDLIN( 777)								 ::Dynamic pmin1;
HXDLIN( 777)								if (::hx::IsNull( e1 )) {
HXLINE( 777)									pmin1 = 0;
            								}
            								else {
HXLINE( 777)									pmin1 = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            								}
HXDLIN( 777)								 ::Dynamic pmax1 = null();
HXDLIN( 777)								if (::hx::IsNull( e3 )) {
HXLINE( 777)									return null();
            								}
            								else {
HXLINE( 777)									if (::hx::IsNull( pmin1 )) {
HXLINE( 777)										pmin1 = this->tokenMin;
            									}
HXDLIN( 777)									if (::hx::IsNull( pmax1 )) {
HXLINE( 777)										pmax1 = this->tokenMax;
            									}
HXDLIN( 777)									return  ::Dynamic(::hx::Anon_obj::Create(5)
            										->setFixed(0,HX_("e",65,00,00,00),e3)
            										->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            										->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax1)
            										->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin1)
            							...
            							break;
            							case (int)3: {
HXLINE( 775)								 ::hscript::ExprDef _hx_tmp = _g->_hx_getObject(0)->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
...
HXDLIN( 777)										return  ::Dynamic(::hx::Anon_obj::Create(5)
            							...
            							break;
            							case (int)26: {
HXLINE( 778)								 ::hscript::ExprDef _hx_tmp = _g->_hx_getObject(0)->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 778)								if ((_hx_tmp->_hx_getIndex() == 1)) {
HXLINE( 778)									::String i = _hx_tmp->_hx_getString(0);
HXDLIN( 778)									 ::hscript::CType t = _g->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXLINE( 779)									 ::Dynamic eret = this->parseExpr();
HXLINE( 780)									 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EReturn(eret);
HXDLIN( 780)									 ::Dynamic pmin;
HXDLIN( 780)									if (::hx::IsNull( eret )) {
HXLINE( 780)										pmin = 0;
            									}
            									else {
HXLINE( 780)										pmin = eret->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            									}
HXDLIN( 780)									 ::Dynamic pmax = null();
HXDLIN( 780)									 ::Dynamic e2;
HXDLIN( 780)									if (::hx::IsNull( e )) {
HXLINE( 780)										e2 = null();
            									}
            									else {
HXLINE( 780)										if (::hx::IsNull( pmin )) {
HXLINE( 780)											pmin = this->tokenMin;
            										}
HXDLIN( 780)										if (::hx::IsNull( pmax )) {
HXLINE( 780)											pmax = this->tokenMax;
            										}
HXDLIN( 780)										e2 =  ::Dynamic(::hx::Anon_obj::Create(5)
            											->setFixed(0,HX_("e",65,00,00,00),e)
            											->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            											->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            											->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 780)									 ::hscript::ExprDef e3 = ::hscript::ExprDef_obj::EFunction(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(2)
            										->setFixed(0,HX_("t",74,00,00,00),t)
            										->setFixed(1,HX_("name",4b,72,ff,48),i))),e2,null(),null());
HXDLIN( 780)									 ::Dynamic pmin1;
HXDLIN( 780)									if (::hx::IsNull( e1 )) {
HXLINE( 780)										pmin1 = 0;
            									}
            									else {
HXLINE( 780)										pmin1 = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            									}
HXDLIN( 780)									 ::Dynamic pmax1 = null();
HXDLIN( 780)									if (::hx::IsNull( e3 )) {
HXLINE( 780)										return null();
            									}
            									else {
HXLINE( 780)										if (::hx::IsNull( pmin1 )) {
HXLINE( 780)											pmin1 = this->tokenMin;
            										}
HXDLIN( 780)										if (::hx::IsNull( pmax1 )) {
HXLINE( 780)											pmax1 = this->tokenMax;
            										}
HXDLIN( 780)										return  ::Dynamic(::hx::Anon_obj::Create(5)
            											->setFixed(0,HX_("e",65,00,00,00),e3)
            											->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            											->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax1)
            											->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin1)
...
HXLINE( 787)						 ::hscript::ExprDef _g = e1->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN( 787)						if ((_g->_hx_getIndex() == 3)) {
HXLINE( 787)							 ::Dynamic _g1 = _g->_hx_getObject(0);
...
HXLINE( 788)						{
HXLINE( 788)							this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            								->setFixed(0,HX_("t",74,00,00,00),tk)
            								->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            								->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 788)							this->tokenMin = this->oldTokenMin;
HXDLIN( 788)							this->tokenMax = this->oldTokenMax;
            						}
HXLINE( 789)						return e1;
            					}
HXLINE( 791)					 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EUnop(op,false,e1);
HXDLIN( 791)					 ::Dynamic pmin;
HXDLIN( 791)					if (::hx::IsNull( e1 )) {
HXLINE( 791)						pmin = 0;
            					}
            					else {
HXLINE( 791)						pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            					}
HXDLIN( 791)					 ::Dynamic pmax = null();
HXDLIN( 791)					 ::Dynamic _hx_tmp1;
HXDLIN( 791)					if (::hx::IsNull( e )) {
HXLINE( 791)						_hx_tmp1 = null();
            					}
            					else {
HXLINE( 791)						if (::hx::IsNull( pmin )) {
HXLINE( 791)							pmin = this->tokenMin;
            						}
HXDLIN( 791)						if (::hx::IsNull( pmax )) {
HXLINE( 791)							pmax = this->tokenMax;
            						}
HXDLIN( 791)						_hx_tmp1 =  ::Dynamic(::hx::Anon_obj::Create(5)
            							->setFixed(0,HX_("e",65,00,00,00),e)
            							->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            							->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            							->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 791)					return this->parseExprNext(_hx_tmp1);
            				}
HXLINE( 793)				return this->makeBinop(op,e1,this->parseExpr());
            			}
            			break;
            			case (int)4: {
HXLINE( 798)				 ::hscript::ExprDef e = ::hscript::ExprDef_obj::ECall(e1,this->parseExprList(::hscript::Token_obj::TPClose_dyn()));
...
HXDLIN( 798)					_hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(5)
            						->setFixed(0,HX_("e",65,00,00,00),e)
            						->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            						->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            						->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 798)				return this->parseExprNext(_hx_tmp);
            			}
            			break;
            			case (int)8: {
HXLINE( 795)				::String field = this->getIdent();
HXLINE( 796)				 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EField(e1,field);
HXDLIN( 796)				 ::Dynamic pmin;
HXDLIN( 796)				if (::hx::IsNull( e1 )) {
HXLINE( 796)					pmin = 0;
            				}
            				else {
HXLINE( 796)					pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            				}
HXDLIN( 796)				 ::Dynamic pmax = null();
HXDLIN( 796)				 ::Dynamic _hx_tmp;
HXDLIN( 796)				if (::hx::IsNull( e )) {
HXLINE( 796)					_hx_tmp = null();
            				}
            				else {
HXLINE( 796)					if (::hx::IsNull( pmin )) {
HXLINE( 796)						pmin = this->tokenMin;
            					}
HXDLIN( 796)					if (::hx::IsNull( pmax )) {
HXLINE( 796)						pmax = this->tokenMax;
            					}
HXDLIN( 796)					_hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(5)
            						->setFixed(0,HX_("e",65,00,00,00),e)
            						->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            						->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            						->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 796)				return this->parseExprNext(_hx_tmp);
            			}
            			break;
            			case (int)11: {
HXLINE( 800)				 ::Dynamic e2 = this->parseExpr();
HXLINE( 801)				{
...
HXLINE( 802)				 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EArray(e1,e2);
HXDLIN( 802)				 ::Dynamic pmin;
HXDLIN( 802)				if (::hx::IsNull( e1 )) {
HXLINE( 802)					pmin = 0;
            				}
            				else {
HXLINE( 802)					pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            				}
HXDLIN( 802)				 ::Dynamic pmax = null();
HXDLIN( 802)				 ::Dynamic _hx_tmp;
HXDLIN( 802)				if (::hx::IsNull( e )) {
HXLINE( 802)					_hx_tmp = null();
            				}
            				else {
HXLINE( 802)					if (::hx::IsNull( pmin )) {
HXLINE( 802)						pmin = this->tokenMin;
            					}
HXDLIN( 802)					if (::hx::IsNull( pmax )) {
HXLINE( 802)						pmax = this->tokenMax;
            					}
HXDLIN( 802)					_hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(5)
            						->setFixed(0,HX_("e",65,00,00,00),e)
            						->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            						->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            						->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXDLIN( 802)				return this->parseExprNext(_hx_tmp);
            			}
            			break;
            			case (int)13: {
HXLINE( 804)				 ::Dynamic e2 = this->parseExpr();
HXLINE( 805)				{
...
HXLINE( 806)				 ::Dynamic e3 = this->parseExpr();
HXLINE( 807)				 ::hscript::ExprDef e = ::hscript::ExprDef_obj::ETernary(e1,e2,e3);
HXDLIN( 807)				 ::Dynamic pmin;
HXDLIN( 807)				if (::hx::IsNull( e1 )) {
HXLINE( 807)					pmin = 0;
            				}
            				else {
HXLINE( 807)					pmin = e1->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic);
            				}
HXDLIN( 807)				 ::Dynamic pmax;
HXDLIN( 807)				if (::hx::IsNull( e3 )) {
HXLINE( 807)					pmax = 0;
            				}
            				else {
HXLINE( 807)					pmax = e3->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic);
            				}
HXDLIN( 807)				if (::hx::IsNull( e )) {
...
HXDLIN( 807)					return  ::Dynamic(::hx::Anon_obj::Create(5)
            			...
            			default:{
HXLINE( 809)				{
HXLINE( 809)					this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            						->setFixed(0,HX_("t",74,00,00,00),tk)
            						->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            						->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 809)					this->tokenMin = this->oldTokenMin;
HXDLIN( 809)					this->tokenMax = this->oldTokenMax;
            				}
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,parseFunctionArgs,return )
 ...
 ::Dynamic Parser_obj::parseFunctionDecl(){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_856_parseFunctionDecl)
HXLINE( 857)		{
...
HXLINE( 863)				this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            					->setFixed(0,HX_("t",74,00,00,00),tk)
            					->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            					->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 863)				this->tokenMin = this->oldTokenMin;
HXDLIN( 863)				this->tokenMax = this->oldTokenMax;
            			}
            			else {
...
::Array< ::String > Parser_obj::parsePath(){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_870_parsePath)
...
HXLINE( 875)				{
HXLINE( 875)					this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            						->setFixed(0,HX_("t",74,00,00,00),t)
            						->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            						->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 875)					this->tokenMin = this->oldTokenMin;
HXDLIN( 875)					this->tokenMax = this->oldTokenMax;
            				}
...
HXLINE( 887)				{
HXLINE( 887)					this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            						->setFixed(0,HX_("t",74,00,00,00),t)
            						->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            						->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 887)					this->tokenMin = this->oldTokenMin;
HXDLIN( 887)					this->tokenMax = this->oldTokenMax;
            				}
...
HXLINE( 904)											 ::haxe::ds::List _hx_tmp = this->tokens;
HXDLIN( 904)											 ::hscript::Token _hx_tmp1 = ::hscript::Token_obj::TOp(op.substr(1,null()));
HXDLIN( 904)											_hx_tmp->add( ::Dynamic(::hx::Anon_obj::Create(3)
...
HXLINE( 916)						this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            							->setFixed(0,HX_("t",74,00,00,00),t)
            							->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            							->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN( 916)						this->tokenMin = this->oldTokenMin;
HXDLIN( 916)						this->tokenMax = this->oldTokenMax;
            					}
            				}
            				else {
            			...
            			case (int)4: {
            				HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::hscript::Parser,_gthis) HXARGC(1)
            				 ::hscript::CType _hx_run(::Array< ::Dynamic> args){
            					HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_928_parseType)
HXLINE( 929)					{
HXLINE( 929)						 ::hscript::Token _g = _gthis->token();
HXDLIN( 929)						if ((_g->_hx_getIndex() == 3)) {
...
HXLINE( 941)									{
HXLINE( 941)										 ::Dynamic _g3 = arg->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXLINE( 942)										if (::hx::IsNotNull( _g3 )) {
HXLINE( 943)											 ::Dynamic v = _g3;
HXLINE( 944)											if (!(this->resumeErrors)) {
HXLINE( 944)												HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)),( (int)(v->__Field(HX_("pmin",22,f7,5a,4a),::hx::paccDynamic)) ),( (int)(v->__Field(HX_("pmax",34,f0,5a,4a),::hx::paccDynamic)) ),this->origin,this->line)));
            											}
            										}
            									}
...
HXDLIN( 954)							switch((int)(_g->_hx_getIndex())){
            								case (int)5: {
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,parseType,return )
 ...
 ::hscript::CType Parser_obj::parseTypeNext( ::hscript::CType t){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1005_parseTypeNext)
...
HXLINE(1010)				{
HXLINE(1010)					this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            						->setFixed(0,HX_("t",74,00,00,00),tk)
            						->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            						->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1010)					this->tokenMin = this->oldTokenMin;
HXDLIN(1010)					this->tokenMax = this->oldTokenMax;
            				}
...
::Array< ::Dynamic> Parser_obj::parseExprList( ::hscript::Token etk){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1027_parseExprList)
...
HXLINE(1032)		{
HXLINE(1032)			this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            				->setFixed(0,HX_("t",74,00,00,00),tk)
            				->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            				->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1032)			this->tokenMin = this->oldTokenMin;
HXDLIN(1032)			this->tokenMax = this->oldTokenMax;
            		}
...
HXLINE(1039)					goto _hx_goto_70;
            				}
HXLINE(1040)				this->unexpected(tk);
HXLINE(1041)				goto _hx_goto_70;
            			}
            		}
            		_hx_goto_70:;
...
::Array< ::Dynamic> Parser_obj::parseModule(::String content,::String __o_origin){
            		::String origin = __o_origin;
            		if (::hx::IsNull(__o_origin)) origin = HX_("hscript",73,8c,18,2c);
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1049_parseModule)
...
HXLINE(1058)				goto _hx_goto_72;
            			}
HXLINE(1059)			{
HXLINE(1059)				this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            					->setFixed(0,HX_("t",74,00,00,00),tk)
            					->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            					->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1059)				this->tokenMin = this->oldTokenMin;
HXDLIN(1059)				this->tokenMax = this->oldTokenMax;
            			}
...
::Array< ::Dynamic> Parser_obj::parseMetadata(){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1065_parseMetadata)
...
HXLINE(1073)				{
HXLINE(1073)					this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            						->setFixed(0,HX_("t",74,00,00,00),tk)
            						->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            						->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1073)					this->tokenMin = this->oldTokenMin;
HXDLIN(1073)					this->tokenMax = this->oldTokenMax;
            				}
HXLINE(1074)				goto _hx_goto_74;
            			}
            		}
            		_hx_goto_74:;
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,parseMetadata,return )
 ...
 ::Dynamic Parser_obj::parseParams(){
            	HX_GC_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1080_parseParams)
HXLINE(1081)		if (this->maybe(::hscript::Token_obj::TOp(HX_("<",3c,00,00,00)))) {
HXLINE(1082)			if (!(this->resumeErrors)) {
HXLINE(1082)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EInvalidOp(HX_("Unsupported class type parameters",9d,ae,a3,50)),this->readPos,this->readPos,this->origin,this->line)));
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,parseParams,return )
 ...
 ::hscript::ModuleDecl Parser_obj::parseModuleDecl(){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1086_parseModuleDecl)
...
HXDLIN(1095)				goto _hx_goto_78;
            			}
            			if (  (_hx_switch_0==HX_("private",03,2d,6f,89)) ){
HXLINE(1093)				isPrivate = true;
HXDLIN(1093)				goto _hx_goto_78;
            			}
            			/* default */{
HXLINE(1097)				goto _hx_goto_77;
            			}
            			_hx_goto_78:;
...
HXDLIN(1137)						goto _hx_goto_81;
            					}
            					if (  (_hx_switch_2==HX_("implements",70,fd,43,a8)) ){
HXLINE(1139)						implement->push(this->parseType());
HXDLIN(1139)						goto _hx_goto_81;
            					}
            					/* default */{
HXLINE(1141)						{
HXLINE(1141)							this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            								->setFixed(0,HX_("t",74,00,00,00),t)
            								->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            								->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1141)							this->tokenMin = this->oldTokenMin;
HXDLIN(1141)							this->tokenMax = this->oldTokenMax;
            						}
HXLINE(1142)						goto _hx_goto_80;
            					}
            					_hx_goto_81:;
            				}
            				else {
...
HXLINE(1112)					{
HXLINE(1112)						this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            							->setFixed(0,HX_("t",74,00,00,00),t)
            							->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            							->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1112)						this->tokenMin = this->oldTokenMin;
HXDLIN(1112)						this->tokenMax = this->oldTokenMax;
            					}
HXLINE(1113)					goto _hx_goto_83;
            				}
...
HXLINE(1232)				return  ::Dynamic(::hx::Anon_obj::Create(4)
            					...
            					->setFixed(2,HX_("meta",c5,4a,59,48),meta)
            					->setFixed(3,HX_("name",4b,72,ff,48),name));
HXLINE(1210)				goto _hx_goto_86;
            			}
            			/* default */{
HXLINE(1244)				this->unexpected(::hscript::Token_obj::TId(id));
HXLINE(1245)				goto _hx_goto_85;
            			}
            			_hx_goto_86:;
            		}
            		_hx_goto_85:;
...
HXLINE(1264)		int p1 = (this->readPos - 1);
...
HXLINE(1270)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EUnterminatedString_dyn(),p1,p1,this->origin,this->line)));
            				}
HXLINE(1271)				goto _hx_goto_89;
            			}
HXLINE(1273)			if (esc) {
...
HXLINE(1297)												HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EUnterminatedString_dyn(),p1,p1,this->origin,this->line)));
            											}
            										}
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,readString,return )
 ...
 ::hscript::Token Parser_obj::token(){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1317_token)
HXLINE(1319)		 ::Dynamic t = this->tokens->pop();
HXLINE(1320)		if (::hx::IsNotNull( t )) {
HXLINE(1321)			this->tokenMin = ( (int)(t->__Field(HX_("min",92,11,53,00),::hx::paccDynamic)) );
HXLINE(1322)			this->tokenMax = ( (int)(t->__Field(HX_("max",a4,0a,53,00),::hx::paccDynamic)) );
HXLINE(1323)			return t->__Field(HX_("t",74,00,00,00),::hx::paccDynamic);
            		}
HXLINE(1325)		this->oldTokenMin = this->tokenMin;
HXLINE(1326)		this->oldTokenMax = this->tokenMax;
HXLINE(1327)		int _hx_tmp;
HXDLIN(1327)		if ((this->_hx_char < 0)) {
HXLINE(1327)			_hx_tmp = this->readPos;
            		}
            		else {
HXLINE(1327)			_hx_tmp = (this->readPos - 1);
            		}
HXDLIN(1327)		this->tokenMin = _hx_tmp;
HXLINE(1328)		 ::hscript::Token t1 = this->_token();
HXLINE(1329)		int _hx_tmp1;
HXDLIN(1329)		if ((this->_hx_char < 0)) {
HXLINE(1329)			_hx_tmp1 = (this->readPos - 1);
            		}
            		else {
HXLINE(1329)			_hx_tmp1 = (this->readPos - 2);
            		}
HXDLIN(1329)		this->tokenMax = _hx_tmp1;
HXLINE(1330)		return t1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,token,return )
 ...
 ::hscript::Token Parser_obj::_token(){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1333__token)
...
HXLINE(1359)					this->tokenMin++;
            				}
            				break;
            				case (int)9: case (int)13: case (int)32: {
HXLINE(1355)					this->tokenMin++;
            				}
            				break;
            				case (int)35: {
...
HXLINE(1391)										{
HXLINE(1391)											this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            												->setFixed(0,HX_("t",74,00,00,00),::hscript::Token_obj::TOp(HX_("...",ee,0f,23,00)))
            												->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            												->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1391)											this->tokenMin = this->oldTokenMin;
HXDLIN(1391)											this->tokenMax = this->oldTokenMax;
            										}
...
HXLINE(1382)											this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            												->setFixed(0,HX_("t",74,00,00,00),tk)
            												->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            												->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1382)											this->tokenMin = this->oldTokenMin;
HXDLIN(1382)											this->tokenMax = this->oldTokenMax;
            										}
            									}
            									break;
            									case (int)3: {
...
HXLINE(1379)													this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            														->setFixed(0,HX_("t",74,00,00,00),tk)
            														->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            														->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1379)													this->tokenMin = this->oldTokenMin;
HXDLIN(1379)													this->tokenMax = this->oldTokenMax;
            												}
            											}
            											else {
HXLINE(1379)												this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,preprocValue,return )
 ...
 ::Dynamic Parser_obj::parsePreproCond(){
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1560_parsePreproCond)
HXLINE(1561)		 ::hscript::Token tk = this->token();
HXLINE(1562)		switch((int)(tk->_hx_getIndex())){
            			case (int)2: {
HXLINE(1566)				::String id = tk->_hx_getString(0);
HXLINE(1567)				 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EIdent(id);
HXDLIN(1567)				 ::Dynamic pmin = this->tokenMin;
HXDLIN(1567)				 ::Dynamic pmax = this->tokenMax;
HXDLIN(1567)				if (::hx::IsNull( e )) {
HXLINE(1567)					return null();
            				}
            				else {
HXLINE(1567)					if (::hx::IsNull( pmin )) {
HXLINE(1567)						pmin = this->tokenMin;
            					}
HXDLIN(1567)					if (::hx::IsNull( pmax )) {
HXLINE(1567)						pmax = this->tokenMax;
            					}
HXDLIN(1567)					return  ::Dynamic(::hx::Anon_obj::Create(5)
            						->setFixed(0,HX_("e",65,00,00,00),e)
            						->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            						->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            						->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE(1569)					 ::hscript::ExprDef e = ::hscript::ExprDef_obj::EUnop(HX_("!",21,00,00,00),true,this->parsePreproCond());
HXDLIN(1569)					 ::Dynamic pmin = this->tokenMin;
HXDLIN(1569)					 ::Dynamic pmax = this->tokenMax;
HXDLIN(1569)					if (::hx::IsNull( e )) {
HXLINE(1569)						return null();
            					}
            					else {
HXLINE(1569)						if (::hx::IsNull( pmin )) {
HXLINE(1569)							pmin = this->tokenMin;
            						}
HXDLIN(1569)						if (::hx::IsNull( pmax )) {
HXLINE(1569)							pmax = this->tokenMax;
            						}
HXDLIN(1569)						return  ::Dynamic(::hx::Anon_obj::Create(5)
            							->setFixed(0,HX_("e",65,00,00,00),e)
            							->setFixed(1,HX_("line",f4,17,b3,47),this->line)
            							->setFixed(2,HX_("pmax",34,f0,5a,4a),pmax)
            							->setFixed(3,HX_("pmin",22,f7,5a,4a),pmin)
...
HXLINE(1571)					return this->unexpected(tk);
            			...
            			case (int)4: {
HXLINE(1564)				{
HXLINE(1564)					this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            						->setFixed(0,HX_("t",74,00,00,00),::hscript::Token_obj::TPOpen_dyn())
            						->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            						->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1564)					this->tokenMin = this->oldTokenMin;
HXDLIN(1564)					this->tokenMax = this->oldTokenMax;
            				}
...
bool Parser_obj::evalPreproCond( ::Dynamic e){
            	HX_GC_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1576_evalPreproCond)
HXDLIN(1576)		 ::hscript::ExprDef _g = e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic);
HXDLIN(1576)		switch((int)(_g->_hx_getIndex())){
            			case (int)1: {
HXLINE(1577)				::String id = _g->_hx_getString(0);
HXLINE(1578)				return ::hx::IsNotNull( this->preprocValue(id) );
            			}
            			break;
            			case (int)3: {
HXLINE(1581)				 ::Dynamic e = _g->_hx_getObject(0);
HXLINE(1582)				return this->evalPreproCond(e);
            			}
            			break;
            			case (int)6: {
HXLINE(1585)				 ::Dynamic _g1 = _g->_hx_getObject(1);
HXDLIN(1585)				 ::Dynamic _g2 = _g->_hx_getObject(2);
HXDLIN(1585)				::String _hx_switch_0 = _g->_hx_getString(0);
            				if (  (_hx_switch_0==HX_("&&",40,21,00,00)) ){
HXLINE(1583)					 ::Dynamic e1 = _g1;
HXDLIN(1583)					 ::Dynamic e2 = _g2;
...
HXLINE(1583)					goto _hx_goto_104;
            				}
            				if (  (_hx_switch_0==HX_("||",80,6c,00,00)) ){
HXLINE(1585)					 ::Dynamic e1 = _g1;
HXDLIN(1585)					 ::Dynamic e2 = _g2;
...
HXLINE(1585)					goto _hx_goto_104;
            				}
            				/* default */{
HXLINE(1588)					{
HXLINE(1588)						 ::hscript::ErrorDef err = ::hscript::ErrorDef_obj::EInvalidPreprocessor((HX_("Can't eval ",01,17,bf,09) + ::Type_obj::enumConstructor(e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic))));
HXDLIN(1588)						if (!(this->resumeErrors)) {
HXLINE(1588)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,err,this->readPos,this->readPos,this->origin,this->line)));
            						}
            					}
HXLINE(1589)					return false;
            			...
            			break;
            			case (int)7: {
HXLINE(1579)				bool _g1 = _g->_hx_getBool(1);
HXDLIN(1579)				if ((_g->_hx_getString(0) == HX_("!",21,00,00,00))) {
HXLINE(1579)					 ::Dynamic e = _g->_hx_getObject(2);
HXLINE(1580)					return !(this->evalPreproCond(e));
            				}
            				else {
HXLINE(1588)					{
HXLINE(1588)						 ::hscript::ErrorDef err = ::hscript::ErrorDef_obj::EInvalidPreprocessor((HX_("Can't eval ",01,17,bf,09) + ::Type_obj::enumConstructor(e->__Field(HX_("e",65,00,00,00),::hx::paccDynamic))));
...
HXLINE(1618)			goto _hx_goto_106;
            		}
            		if (  (_hx_switch_0==HX_("if",dd,5b,00,00)) ){
HXLINE(1596)			 ::Dynamic e = this->parsePreproCond();
...
HXLINE(1633)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EInvalidPreprocessor(HX_("Unclosed",e5,94,4a,ea)),pos,pos,this->origin,this->line)));
            				}
            			}
HXLINE(1634)			if (::hx::IsNotEq( this->preprocStack->__get(spos),obj )) {
HXLINE(1635)				{
HXLINE(1635)					this->tokens->push( ::Dynamic(::hx::Anon_obj::Create(3)
            						->setFixed(0,HX_("t",74,00,00,00),tk)
            						->setFixed(1,HX_("max",a4,0a,53,00),this->tokenMax)
            						->setFixed(2,HX_("min",92,11,53,00),this->tokenMin)));
HXDLIN(1635)					this->tokenMin = this->oldTokenMin;
HXDLIN(1635)					this->tokenMax = this->oldTokenMax;
            				}
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,skipTokens,(void))
 ...
 ::hscript::Token Parser_obj::tokenComment(::String op,int _hx_char){
            	HX_GC_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_1641_tokenComment)
...
HXLINE(1664)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EUnterminatedComment_dyn(),this->tokenMin,this->tokenMin,this->origin,this->line)));
            						}
HXLINE(1665)						goto _hx_goto_112;
            					}
            				}
            				_hx_goto_112:;
...
HXLINE(1671)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::hscript::Error_obj::__alloc( HX_CTX ,::hscript::ErrorDef_obj::EUnterminatedComment_dyn(),this->tokenMin,this->tokenMin,this->origin,this->line)));
            					}
HXLINE(1672)					goto _hx_goto_111;
            				}
HXLINE(1674)				if ((_hx_char == 47)) {
HXLINE(1675)					goto _hx_goto_111;
            				}
            			}
            			_hx_goto_111:;
