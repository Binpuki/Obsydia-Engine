...
HX_LOCAL_STACK_FRAME(_hx_pos_badf7fe26ae152fc_15_create,"OutdatedSubState","create",0xa86f5ef1,"OutdatedSubState.create","OutdatedSubState.hx",15,0x9d3df485)
...
void OutdatedSubState_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_badf7fe26ae152fc_15_create)
HXLINE(  16)		this->super::create();
HXLINE(  17)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-16777216,null(),null());
HXLINE(  18)		this->add(bg);
HXLINE(  19)		::String ver = (HX_("v",76,00,00,00) + ::lime::app::Application_obj::current->meta->get(HX_("version",18,e7,f1,7c)));
HXLINE(  20)		 ::flixel::text::FlxText txt =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,::flixel::FlxG_obj::width,((((HX_("HEY! You're running an outdated version of the game!\nCurrent version is ",ec,0f,b6,23) + ver) + HX_(" while the most recent version is ",a8,e4,a2,d4)) + ::NGio_obj::GAME_VER) + HX_("! Press Space to go to itch.io, or ESCAPE to ignore this!!",05,bf,2d,e7)),32,null());
HXLINE(  27)		txt->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),32,-1,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE(  28)		{
HXLINE(  28)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN(  28)			bool _hx_tmp;
HXDLIN(  28)			switch((int)(axes->_hx_getIndex())){
...
HXDLIN(  28)				txt->set_x(((( (Float)(_hx_tmp) ) - txt->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  28)				txt->set_y(((( (Float)(_hx_tmp) ) - txt->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXDLIN(  36)			if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(HX_("https://ninja-muffin24.itch.io/funkin",69,b0,72,92)))) {
HXLINE(  36)				prefix = HX_("http://",52,75,cd,5a);
            			}
HXDLIN(  36)			::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + HX_("https://ninja-muffin24.itch.io/funkin",69,b0,72,92))),HX_("_blank",95,26,d9,b0));
            		}
