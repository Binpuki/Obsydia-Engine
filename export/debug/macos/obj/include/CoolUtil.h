...
class HXCPP_CLASS_ATTRIBUTES CoolUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static int fromKeyCodeToFlxKey(int key,int poop);
		static ::Dynamic fromKeyCodeToFlxKey_dyn();

		static int fromKeyModifierToFlxKey(int poop);
		static ::Dynamic fromKeyModifierToFlxKey_dyn();
