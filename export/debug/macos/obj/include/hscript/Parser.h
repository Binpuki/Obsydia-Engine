...
class HXCPP_CLASS_ATTRIBUTES Parser_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic getIdent_dyn();
		 ...
		 ::hscript::ExprDef expr( ::Dynamic e);
		::Dynamic expr_dyn();
		...
		::Dynamic pmax_dyn();
		 ...
		 ::Dynamic mk( ::hscript::ExprDef e, ::Dynamic pmin, ::Dynamic pmax);
		::Dynamic mk_dyn();
		...
		::Dynamic makeBinop_dyn();
		 ...
		 ::Dynamic parseStructure(::String id);
		...
		virtual ::Array< ::Dynamic> parseModule(::String content,::String origin);
